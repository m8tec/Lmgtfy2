...
}
{
  ...
  !(function (t, e) {
    ...
    function a(t, e, n) {
      ...
      if ((s.setAttribute("class", "tippy-content"), n.arrow)) {
        ...
        (u.style[i("transform")] = n.arrowTransform),
          "round" === n.arrowType
            ? (u.classList.add("tippy-roundarrow"),
              (u.innerHTML =
      ...
      if (l) {
        ...
        l instanceof Element
          ? (s.appendChild(l), (f = "#" + (l.id || "tippy-html-template")))
          : ((s.innerHTML = document.querySelector(l).innerHTML), (f = l)),
    ...
    function s(t, e, n, r) {
      ...
      return (
        r.target
          ? (Qt.supportsTouch &&
              r.touchHold &&
              (l("touchstart", s), l("touchend", u)),
            "mouseenter" === t && (l("mouseover", s), l("mouseout", u)),
            "focus" === t && (l("focusin", s), l("focusout", u)),
            "click" === t && l("click", s))
          : (l(t, i),
            Qt.supportsTouch &&
              r.touchHold &&
              (l("touchstart", i), l("touchend", o)),
    ...
    function b(t) {
      ...
      for (
        var e = y(10) ? document.body : null, n = t.offsetParent;
    ...
    function X(t, e, n, r) {
      ...
      var i = v(t);
      return (
        G(i, "scroll", n.updateBound, n.scrollParents),
        (n.scrollElement = i),
        (n.eventsEnabled = !0),
        n
      );
    ...
    function ot(t, e) {
      ...
      var a = void 0 !== o ? o : e.gpuAcceleration,
        ...
        m = void 0;
      if (
        ((m = "bottom" === f ? -u.height + l.bottom : l.top),
      ...
      return (
        (t.attributes = ge({}, y, t.attributes)),
    ...
    function st(t, e) {
      ...
      return (
        ($ = Math.max(Math.min(a[c] - h, $), 0)),
        (t.arrowElement = r),
        (t.offsets.arrow =
          ((n = {}), me(n, f, Math.round($)), me(n, p, ""), n)),
        t
      );
    }
    function ut(t) {
      ...
      var r = wt(t),
        ...
        f = n
          .replace(
            c.translate,
            "translate" +
              _t(l.translate.axis, o) +
              "(" +
              Tt("translate", l.translate.numbers, o, a) +
              ")"
          )
          .replace(
            c.scale,
    ...
    function Mt(t) {
      ...
      if ((Nt.call(this), !this.state.visible)) {
        ...
        if (((this._(Ee).isPreparingToShow = !0), n.wait))
        ...
        if (Rt.call(this)) {
          ...
          i && (i.style.margin = "0"),
            document.addEventListener(
              "mousemove",
              this._(Ee).followCursorListener
            );
        }
        var o = Dt(n.delay, 0);
        o
          ? (this._(Ee).showTimeout = setTimeout(function () {
              e.show();
            }, o))
          : this.show();
      }
    ...
    function Lt() {
      ...
      if ((Nt.call(this), this.state.visible)) {
        ...
        e
          ? (this._(Ee).hideTimeout = setTimeout(function () {
      ...
      var t = this,
        e = function (e) {
          if (t.state.enabled) {
            ...
            (n && t.options.touchHold) ||
              ((t._(Ee).lastTriggerEvent = e),
              "click" === e.type &&
    ...
    function Ht(t) {
      ...
      if (
        (this.popperInstance
          ...
          : ((this.popperInstance = jt.call(this)),
    ...
    function zt(t, e) {
      return t.reduce(function (t, n) {
        ...
        i.createPopperInstanceOnInit &&
          ((d.popperInstance = jt.call(d)),
          d.popperInstance.disableEventListeners());
        var h = Ft.call(d);
        return (
          (d.listeners = i.trigger
            .trim()
            .split(" ")
            .reduce(function (t, e) {
          ...
          i.dynamicTitle &&
            qt.call(d, {
              ...
              callback: function () {
                ...
                r &&
                  ((e[i.allowTitleHTML ? "innerHTML" : "textContent"] =
                    d.title =
                      r),
                  f(n));
              },
    ...
    function Wt(t) {
      ...
      n.forEach(function (e) {
        ...
        if (n) {
          var r = n.options;
          !(r.hideOnClick === !0 || r.trigger.indexOf("focus") > -1) ||
            (t && e === t.popper) ||
            n.hide();
        }
      });
    ...
    for (
      var Zt = {
        ...
        ee = Qt.supported && Object.keys(te),
        ne = function (t, e) {
          if (!(t instanceof e))
      ...
      Se = (function () {
        function t(e, n) {
          ...
          de(this, t),
            ...
            Object.keys(ge({}, t.Defaults.modifiers, i.modifiers)).forEach(
              function (e) {
                r.options.modifiers[e] = ge(
                  {},
    ...
    if (Xt) {
      ...
      Te =
        _e.matches ||
        _e.matchesSelector ||
        _e.webkitMatchesSelector ||
        _e.mozMatchesSelector ||
        _e.msMatchesSelector ||
        function (t) {
          for (
                  ...
                  if (
                    ...
                    o.onShow.call(n, this),
                      ...
                      Ht.call(this, function () {
                        if (e.state.visible) {
                          if (
                            (Rt.call(e) || e.popperInstance.scheduleUpdate(),
                            Rt.call(e))
                          ) {
                            ...
                            l &&
                              e
                                ...
                                .followCursorListener(
                                  a && e._(Ee).lastMouseMoveEvent
                                    ? e._(Ee).lastMouseMoveEvent
                                    : l
                                );
                          }
                          At([s, u, u ? c : null], t),
                    ...
                    Ct(function () {
                      Bt.call(e, t, function () {
                        !e.state.visible &&
                          ...
                          (e._(Ee).isPreparingToShow ||
                            (document.removeEventListener(
                              "mousemove",
                              e._(Ee).followCursorListener
                            ),
    ...
    (function (t, e) {
                  ...
                  e.on(n(o, "move"), function (e) {
                    if (l && u) {
                      ...
                      if (
                        ...
                        return s > a
                          ? ((l = !1), void (i.cancel && i.cancel(e)))
                          : (e.preventDefault(), void (i.move && i.move(n, e)));
                    }
                  }),
      ...
      var a = [
        ...
        function (t, r, i) {
          ...
          function c(t, e) {
            f ||
              (i[0].addEventListener("click", s, !0),
            ...
            r.on("touchstart", function (t) {
              ...
              r.on("touchend", function (t) {
                ...
                p &&
                  ...
                  (c(v, y),
                  a && a.blur(),
                  (e.isDefined(i.disabled) && i.disabled !== !1) ||
                    r.triggerHandler("click", [t])),
                  o();
              }),
              (r.onclick = function () {}),
    ...
    (function (t, e) {
      ...
      function o(t, e, n) {
        var r = "";
        return (
          (t = G(t) ? t : t && tt(t) && t.length ? t.split(/\s+/) : []),
          K(t, function (t, i) {
            t &&
              t.length > 0 &&
              ((r += i > 0 ? " " : ""), (r += n ? e + t : t + e));
      ...
      function f(t) {
        return function (e, n) {
          n.addClass && (c(t, e, n.addClass), (n.addClass = null)),
            n.removeClass && (l(t, e, n.removeClass), (n.removeClass = null));
        };
      }
      function p(t) {
        if (((t = t || {}), !t.$$prepared)) {
      ...
      function g(t, e, n) {
        ...
        i.preparationClasses &&
          ((r.preparationClasses = _(
            i.preparationClasses,
      ...
      function v(t, e, n) {
        ...
        return (
          K(a, function (e, n) {
            var r, a;
            e === i
              ? ((r = "addClass"), (a = !t[n] || t[n + H]))
              : e === o && ((r = "removeClass"), (a = t[n] || t[n + j])),
              a && (s[r].length && (s[r] += " "), (s[r] += n));
          }),
          s
        );
      }
      ...
      function b(t, e, n) {
        ...
        e && (r = o(e, N, !0)),
          ...
          r.length && ((n.preparationClasses = r), t.addClass(r));
      }
      function $(t, e) {
        e.preparationClasses &&
          (t.removeClass(e.preparationClasses), (e.preparationClasses = null)),
          e.activeClasses &&
            (t.removeClass(e.activeClasses), (e.activeClasses = null));
      }
      function w(t, e) {
        var n = e ? "-" + e + "s" : "";
      ...
      var R,
        ...
        B = "$$ngAnimateChildren",
        z = "";
      void 0 === t.ontransitionend && void 0 !== t.onwebkittransitionend
        ? ((z = "-webkit-"),
          (R = "WebkitTransition"),
          (I = "webkitTransitionEnd transitionend"))
        : ((R = "transition"), (I = "transitionend")),
        void 0 === t.onanimationend && void 0 !== t.onwebkitanimationend
          ? ((z = "-webkit-"),
            (M = "WebkitAnimation"),
            (L = "webkitAnimationEnd animationend"))
          : ((M = "animation"), (L = "animationend"));
      var W,
        Y,
        K,
        G,
          ...
          function (t) {
            return {
              link: function (e, n, r) {
                ...
                tt(o) && 0 === o.length
                  ? n.data(B, !0)
                  : (i(t(o)(e)), r.$observe("ngAnimateChildren", i));
              },
            };
          },
        ],
              ...
              function (n, r, s, u, c, l, g, v) {
                ...
                function $(e, r, i, o) {
                  ...
                  return (
                    a ||
                      ((a = C(n, e, o)),
                      "infinite" === a.animationIterationCount &&
                        (a.animationIterationCount = 1)),
                    t.put(i, a),
                    a
                  );
                }
                ...
                function A(t, e, n) {
                  var r = $(t, e, n, St),
                    ...
                    o = r.transitionDelay;
                  return (
                    (r.maxDelay = i && o ? Math.max(i, o) : i || o),
                    (r.maxDuration = Math.max(
                      r.animationDuration * r.animationIterationCount,
                ...
                return function (e, n) {
                        ...
                        Object.keys(z).length &&
                          K(z, function (t, e) {
                            t
                              ...
                              : Y.style.removeProperty(e);
                          }),
                        B.onDone && B.onDone(),
                        dt && dt.length && e.off(dt.join(" "), U);
                      var n = e.data(yt);
                      n && (u.cancel(n[0].timer), e.removeData(yt)),
                        Z && Z.complete(!t);
                    }
                  }
                  function $(t) {
                  ...
                  function q() {
                    function t() {
                      if (!X) {
                        ...
                        if (
                          (Ht.applyAnimationDelay &&
                            ((jt =
                              "boolean" != typeof B.delay && D(B.delay)
                                ? parseFloat(B.delay)
                                : jt),
                            (et = Math.max(jt, 0)),
                          ...
                          var t,
                            i = B.easing;
                          Ht.hasTransitions &&
                            ((t = R + st), ct.push([t, i]), (Y.style[t] = i)),
                            Ht.hasAnimations &&
                              ((t = M + st), ct.push([t, i]), (Y.style[t] = i));
                        }
                        ...
                        dt.length && e.on(dt.join(" "), U),
                          B.to &&
                            (B.cleanupStyles && O(z, Y, Object.keys(B.to)),
                            m(e, B));
                      }
                    }
                    function n() {
                      ...
                      var i = function (t) {
                        ...
                        o =
                          ...
                          ((Ft.transitionDuration &&
                            0 === Dt.transitionDuration) ||
                            (Ft.animationDuration &&
                              0 === Dt.animationDuration)) &&
                          Math.max(Dt.animationDelay, Dt.transitionDelay);
                  ...
                  mt ? (gt = o(ht, N, !0)) : ht && (gt = ht),
                    ...
                    B.removeClass &&
                      (vt.length && (vt += " "), (vt += o(B.removeClass, H))),
                  ...
                  if (
                    ...
                    (Ht.hasAnimations = Ft.animationDuration > 0),
                    (Ht.hasTransitionAll =
                      Ht.hasTransitions && "all" === Ft.transitionProperty),
                    (Ht.applyTransitionDuration =
                      Et &&
                      ((Ht.hasTransitions && !Ht.hasTransitionAll) ||
                        (Ht.hasAnimations && !Ht.hasTransitions))),
                    (Ht.applyAnimationDuration =
                      B.duration && Ht.hasAnimations),
                    (Ht.applyTransitionDelay =
                      D(B.delay) &&
                      (Ht.applyTransitionDuration || Ht.hasTransitions)),
                    (Ht.applyAnimationDelay = D(B.delay) && Ht.hasAnimations),
                    (Ht.recalculateTimingStyles = vt.length > 0),
                    (Ht.applyTransitionDuration || Ht.applyAnimationDuration) &&
                  ...
                  if (null != B.delay) {
                    var Nt;
                    "boolean" != typeof B.delay &&
                      ((Nt = parseFloat(B.delay)), (et = Math.max(Nt, 0))),
                      Ht.applyTransitionDelay && ct.push(E(Nt)),
                      Ht.applyAnimationDelay && ct.push(E(Nt, !0));
                  }
                  return (
                    null == B.duration &&
                      Ft.transitionDuration > 0 &&
                      (Ht.recalculateTimingStyles =
                        Ht.recalculateTimingStyles || Lt),
                    (nt = et * bt),
                    (at = it * bt),
                    B.skipBlocking ||
                      ((Ht.blockTransition = Ft.transitionDuration > 0),
                      (Ht.blockKeyframeAnimation =
                        Ft.animationDuration > 0 &&
                        Dt.animationDelay > 0 &&
                        0 === Dt.animationDuration)),
                    B.from &&
                      (B.cleanupStyles && O(z, Y, Object.keys(B.from)),
                      h(e, B)),
                    Ht.blockTransition || Ht.blockKeyframeAnimation
                      ? $(it)
                      : B.skipBlocking || w(Y, !1),
                    {
                      $$willAnimate: !0,
                      end: c,
                      start: function () {
              ...
              function (t, a, s, u, c, l, f) {
                ...
                function h(e, a, u) {
                  function c(t) {
                    ...
                    return (
                      K(["width", "height", "top", "left"], function (t) {
                        var r = n[t];
                        switch (t) {
                          case "top":
                            r += v.scrollTop;
                ...
                function g(e) {
                  ...
                  e.structural &&
                    ...
                    r.preparationClasses &&
                      (r.event = _(r.event, r.preparationClasses));
                  var i = t(n, r);
                ...
                return function (t) {
                  return t.from && t.to
                    ? m(t.from, t.to, t.classes, t.anchors)
                    : g(t);
                };
              },
            ];
              ...
              function (e, n, r) {
                ...
                return function (t, e, r, a) {
                  ...
                  function c(t, e, r, i, o) {
                    ...
                    var s = t.apply(t, a);
                    if (s)
                      if ((Q(s.start) && (s = s.start()), s instanceof n))
                        s.done(o);
                  ...
                  function f(t, e, r, i, o) {
                    ...
                    if (0 === a.length) {
                      var s, u;
                      "beforeSetClass" === o
                        ? ((s = l(t, "removeClass", r, i, "beforeRemoveClass")),
                          (u = l(t, "addClass", r, i, "beforeAddClass")))
                        : "setClass" === o &&
                          ((s = l(t, "removeClass", r, i, "removeClass")),
                  ...
                  var h = !1;
                  3 === arguments.length && Z(r) && ((a = r), (r = null)),
                    (a = p(a)),
                    r ||
                      ((r = t.attr("class") || ""),
                  ...
                  if (b.length) {
                    ...
                    "leave" === e
                      ? ((w = "leave"), ($ = "afterLeave"))
                      : ((w =
                          "before" + e.charAt(0).toUpperCase() + e.substr(1)),
                        ($ = e)),
                  ...
                  if (m || g) {
                    ...
                    return {
                      $$willAnimate: !0,
                        ...
                        return (
                          S ? S.end() : (u(), (S = new n()), S.complete(!0)), S
                        );
                      },
                      start: function () {
                        function t(t) {
          ...
          function (e) {
            ...
            m.join.push(function (t) {
              ...
              (this.$get = [
                ...
                "$$forceReflow",
                "$$isDocumentHidden",
                function (r, i, h, m, v, w, S, T, _, k, E) {
                  function C() {
                    var t = !1;
                    return function (e) {
                      t
                  ...
                  function O(t, e, n) {
                    ...
                    var _ = new S(),
                      k = C();
                    if (
                      (G(h.addClass) && (h.addClass = h.addClass.join(" ")),
                    ...
                    var P = ["enter", "move", "leave"].indexOf(e) >= 0,
                      ...
                      V = (!F && j.get(v)) || {},
                      U = !!V.state;
                    if ((F || (U && V.state === c) || (F = !M(v, T, e)), F))
                      return (
                        O && u(_, e, "start"), f(), O && u(_, e, "close"), _
                      );
                    P && R(v);
                    var q = {
                      structural: P,
                    ...
                    if (
                      (X ||
                        (X =
                          ("animate" === q.event &&
                            Object.keys(q.options.to || {}).length > 0) ||
                          a(q)),
                      !X)
                    )
                      return f(), I(v), _;
                    ...
                    return (
                      ...
                      i.$$postDigest(function () {
                        ...
                        var i = m.parent() || [],
                          o =
                            i.length > 0 &&
                            ("animate" === n.event || n.structural || a(n));
                        if (r || n.counter !== J || !o)
                          return (
                            r && (ot(m, h), d(m, h)),
                            (r || (P && n.event !== e)) &&
                              (h.domOperation(), _.end()),
                            void (o || I(v))
                          );
                  ...
                  var j = new v(),
                    ...
                    at =
                      ...
                      function (t) {
                        return (
                          this === t || !!(16 & this.compareDocumentPosition(t))
                        );
                      },
                    st = {
                      on: function (t, e, n) {
                      ...
                      off: function (t, e, n) {
                        if (1 !== arguments.length || tt(arguments[0])) {
                          var r = U[t];
                          r &&
                            (U[t] = 1 === arguments.length ? null : P(r, e, n));
                        } else {
                          e = arguments[0];
              ...
              function (a, s, u, c, l, h) {
                ...
                return function (l, f, b) {
                  ...
                  function k(t, e) {
                    ...
                    t.from && t.to
                      ? (r(t.from.element), r(t.to.element))
                      : r(t.element);
                  }
                  function E() {
                    var t = n(l);
      ...
      e.module("ngAnimate", [], function () {
        ...
        .directive("ngAnimateSwap", Ot)
        .directive("ngAnimateChildren", vt)
        .factory("$$rAFScheduler", gt)
        .provider("$$animateQueue", Pt)
        .provider("$$animation", At)
        .provider("$animateCss", _t)
        .provider("$$animateCssDriver", kt)
        .provider("$$animateJs", Et)
    ...
    (function (t, e, n) {
      ...
      function r(t, n, r, i, o, a) {
        ...
        this.compile = function (e) {
          ...
          if (
            (angular.forEach(f, function (t, e) {
          ...
          return (
            e.titleTemplate &&
              (f.$template = t
                .all([f.$template, u(e.titleTemplate)])
                .then(function (t) {
            ...
            e.contentTemplate &&
              (f.$template = t
                .all([f.$template, u(e.contentTemplate)])
                .then(function (t) {
                  var n = angular.element(t[0]),
                    r = s('[ng-bind="content"]', n[0])
                      .removeAttr("ng-bind")
                      .html(t[1]);
                ...
                function a(e, n, a) {
                  ...
                  (f.$resetMatches = function () {
                    ...
                    (u.select = function (t) {
                      if (-1 !== t) {
                        ...
                        n.$setViewValue(e),
                          ...
                          angular.isDefined(c.onSelect) &&
                            angular.isFunction(c.onSelect) &&
                            c.onSelect(e, t, u);
                      }
                    }),
                    (u.$isVisible = function () {
                      return c.minLength && n
                        ? f.$matches.length &&
                            angular.isString(n.$viewValue) &&
                            n.$viewValue.length >= c.minLength
                        : !!f.$matches.length;
                    }),
                    (u.$getIndex = function (t) {
                      ...
                      for (
                        e = f.$matches.length;
                        e-- && !angular.equals(f.$matches[e].value, t);
                    ...
                    (u.$onKeyDown = function (t) {
                      /(38|40|13)/.test(t.keyCode) &&
                        (!u.$isVisible() ||
                          (13 === t.keyCode && -1 === f.$activeIndex) ||
                          (t.preventDefault(), t.stopPropagation()),
                        13 === t.keyCode && f.$matches.length
                          ? u.select(f.$activeIndex)
                          : 38 === t.keyCode && f.$activeIndex > 0
                          ? f.$activeIndex--
                          : 40 === t.keyCode &&
                            f.$activeIndex < f.$matches.length - 1
                          ? f.$activeIndex++
                          : angular.isUndefined(f.$activeIndex) &&
                            (f.$activeIndex = 0),
                  ...
                  u.show = function () {
                    p(),
                      o(
                        function () {
                          u.$element &&
                            (u.$element.on("mousedown", u.$onMouseDown),
            ...
            function (t, e, n, r, i) {
              ...
              return {
                ...
                link: function (t, e, n, a) {
                  ...
                  var u = /^(false|0|)$/i;
                  angular.forEach(
                    ["html", "container", "trimValue", "filter"],
                    function (t) {
                  ...
                  t.$watch(n.ngModel, function (e) {
                    (t.$modelValue = e),
                      d.valuesFn(t, a).then(function (t) {
                        return s.selectMode && !t.length && e.length > 0
                          ? void a.$setViewValue(
                              a.$viewValue.substring(0, a.$viewValue.length - 1)
                            )
                          : (t.length > l && (t = t.slice(0, l)),
                            h.update(t),
                            void a.$render());
                      });
                  }),
                    a.$formatters.push(function (t) {
                      ...
                      return e
                        ? e
                        : angular.isDefined(t) && "object" != typeof t
                        ? t
                        : "";
                    }),
                    (a.$render = function () {
                      ...
                      var t = h.$getIndex(a.$modelValue),
                        n =
                          -1 !== t ? h.$scope.$matches[t].label : a.$viewValue;
        ...
        angular
          ...
          .provider("$tooltip", function () {
            ...
            this.$get = [
              ...
              "$$rAF",
              "$timeout",
              function (n, r, i, o, a, s, u, c, l, f, p) {
                function d(o, a) {
                  function s() {
                    I.$emit(O.prefixEvent + ".show", A),
                      angular.isDefined(O.onShow) &&
                        angular.isFunction(O.onShow) &&
                        O.onShow(A);
                  }
                  function d() {
                    if (
                      (I.$emit(O.prefixEvent + ".hide", A),
                      angular.isDefined(O.onHide) &&
                        angular.isFunction(O.onHide) &&
                        O.onHide(A),
                      N === B)
                    ) {
                  ...
                  function g() {
                    ...
                    angular.forEach(t, function (t) {
                      "click" === t || "contextmenu" === t
                        ? o.on(t, A.toggle)
                        : "manual" !== t &&
                          (o.on(
                            "hover" === t ? "mouseenter" : "focus",
                            A.enter
                          ),
                  ...
                  function b() {
                    for (var t = O.trigger.split(" "), e = t.length; e--; ) {
                      var n = t[e];
                      "click" === n || "contextmenu" === n
                        ? o.off(n, A.toggle)
                        : "manual" !== n &&
                          (o.off(
                            "hover" === n ? "mouseenter" : "focus",
                            A.enter
                          ),
                  ...
                  function $() {
                    "focus" !== O.trigger
                      ? N.on("keyup", A.$onKeyUp)
                      : o.on("keyup", A.$onFocusKeyUp);
                  }
                  function w() {
                    "focus" !== O.trigger
                      ? N.off("keyup", A.$onKeyUp)
                      : o.off("keyup", A.$onFocusKeyUp);
                  }
                  function S() {
                    p(
                      function () {
                  ...
                  function P() {
                    clearTimeout(F),
                      A.$isShown &&
                        null !== N &&
                        (O.autoClose && T(), O.keyboard && w()),
                      U && (U.$destroy(), (U = null)),
                      N && (N.remove(), (N = A.$element = null));
                  }
                  var A = {},
                  ...
                  R.then(function (t) {
                    ...
                    (A.init = function () {
                      O.delay &&
                        ...
                        "self" === O.container
                          ? (V = o)
                          : angular.isElement(O.container)
                          ? (V = O.container)
                          : O.container && (V = m(O.container)),
                        g(),
                        O.target &&
                          (O.target = angular.isElement(O.target)
                            ? O.target
                            : m(O.target)),
                        O.show &&
                          I.$$postDigest(function () {
                    ...
                    (A.show = function () {
                      if (O.bsEnabled && !A.$isShown) {
                        I.$emit(O.prefixEvent + ".show.before", A),
                          angular.isDefined(O.onBeforeShow) &&
                            angular.isFunction(O.onBeforeShow) &&
                            O.onBeforeShow(A);
                        var t, e;
                        O.container
                          ? ((t = V),
                            (e = V[0].lastChild
                              ? angular.element(V[0].lastChild)
                              : null))
                          : ((t = null), (e = o)),
                          N && P(),
                          (U = A.$scope.$new()),
                  ...
                  (A.hide = function (t) {
                    A.$isShown &&
                      (I.$emit(O.prefixEvent + ".hide.before", A),
                      angular.isDefined(O.onBeforeHide) &&
                        angular.isFunction(O.onBeforeHide) &&
                        O.onBeforeHide(A),
                      (q = t),
                      (B = N),
                      null !== N &&
                    ...
                    (A.$applyPlacement = function () {
                      if (N) {
                        ...
                        if (
                          ((A.$viewport =
                            O.viewport && m(O.viewport.selector || O.viewport)),
                          r)
                        ) {
                          var s = e,
                            u = k(A.$viewport);
                          /bottom/.test(s) && i.bottom + a > u.bottom
                            ? (e = s.replace("bottom", "top"))
                            : /top/.test(s) &&
                              i.top - a < u.top &&
                              (e = s.replace("top", "bottom")),
                            /left/.test(s) && i.left - o < u.left
                              ? (e = e.replace("left", "right"))
                              : /right/.test(s) &&
                                i.right + o > u.width &&
                                (e = e.replace("right", "left")),
                ...
                var g = /(ip[ao]d|iphone|android)/gi.test(
            ...
            function (t, e, n, r, i, o) {
              return {
                ...
                link: function (t, e, r) {
                  ...
                  angular.isDefined(c) &&
                    (u.test(c) ? (s.target = !1) : (s.target = c)),
                    ...
                    r.bsShow &&
                      t.$watch(r.bsShow, function (t) {
                        a &&
                          angular.isDefined(t) &&
                          (angular.isString(t) &&
                            (t = !!t.match(/true|,?(tooltip),?/i)),
                          t === !0 ? a.show() : a.hide());
                      }),
                    r.bsEnabled &&
                      t.$watch(r.bsEnabled, function (t) {
                        a &&
                          angular.isDefined(t) &&
                          (angular.isString(t) &&
                            (t = !!t.match(/true|1|,?(tooltip),?/i)),
                          t === !1 ? a.setEnabled(!1) : a.setEnabled(!0));
                      }),
                    r.viewport &&
                      t.$watch(r.viewport, function (t) {
              ...
              function (e, n, r, i, o, a, s) {
                function u(e, n, r) {
                  ...
                  function u(t, n) {
                    ...
                    if (e[0].createTextRange) {
                      ...
                      e[0].setSelectionRange
                        ? e[0].setSelectionRange(t, r)
                        : angular.isUndefined(e[0].selectionStart) &&
                          ((e[0].selectionStart = t), (e[0].selectionEnd = r));
                  }
                  function f() {
                    e[0].focus();
                  }
                  ...
                  (m.$iconUp = h.iconUp),
                    ...
                    (p.update = function (t) {
                      angular.isDate(t) && !isNaN(t.getTime())
                        ? ((p.$date = t),
                          angular.extend(w, {
                            hour: t.getHours(),
                            minute: t.getMinutes(),
                    ...
                    (p.select = function (t, e, r) {
                      (n.$dateValue && !isNaN(n.$dateValue.getTime())) ||
                        ...
                        0 === e
                          ? n.$dateValue.setHours(t.getHours())
                          : 1 === e
                          ? n.$dateValue.setMinutes(t.getMinutes())
                          : 2 === e && n.$dateValue.setSeconds(t.getSeconds()),
                    ...
                    (p.$build = function () {
                      var t,
                        e,
                        n = (m.midIndex = parseInt(h.length / 2, 10)),
                        r = [];
                    ...
                    (p.$isSelected = function (t, e) {
                      return p.$date
                        ? 0 === e
                          ? t.getHours() === p.$date.getHours()
                          : 1 === e
                          ? t.getMinutes() === p.$date.getMinutes()
                          : 2 === e
                          ? t.getSeconds() === p.$date.getSeconds()
                          : void 0
                        : !1;
                    }),
                    (p.$isDisabled = function (t, e) {
                      ...
                      return (
                        0 === e
                          ? (n = t.getTime() + 6e4 * w.minute + 1e3 * w.second)
                          : 1 === e
                          ? (n = t.getTime() + 36e5 * w.hour + 1e3 * w.second)
                          : 2 === e &&
                            (n = t.getTime() + 36e5 * w.hour + 6e4 * w.minute),
                        n < 1 * h.minTime || n > 1 * h.maxTime
                      );
                    }),
                    (m.$arrowAction = function (t, e) {
                      "picker" === h.arrowBehavior
                        ? p.$setTimeByStep(t, e)
                        : p.$moveIndex(t, e);
                    }),
                    (p.$setTimeByStep = function (t, e) {
                      var n = new Date(p.$date || $),
                        ...
                        o = n.getSeconds();
                      0 === e
                        ? n.setHours(r - parseInt(h.hourStep, 10) * t)
                        : 1 === e
                        ? n.setMinutes(i - parseInt(h.minuteStep, 10) * t)
                        : 2 === e &&
                          n.setSeconds(o - parseInt(h.secondStep, 10) * t),
                        p.select(n, e, !0);
                    }),
                    (p.$moveIndex = function (t, e) {
                      ...
                      0 === e
                        ...
                        ? ((n = new Date(
                            ...
                            1,
                            w.hour,
                            w.minute + t * h.length * h.minuteStep,
                            w.second
                          )),
                          angular.extend(w, {
                            minute: n.getMinutes(),
                        ...
                        : 2 === e &&
                          ((n = new Date(
                            ...
                            w.hour,
                            w.minute,
                            w.second + t * h.length * h.secondStep
                          )),
                          angular.extend(w, {
                            second: n.getSeconds(),
                          })),
                    ...
                    (p.$onMouseDown = function (t) {
                      if (
                        ...
                        "button" !== e[0].nodeName.toLowerCase() &&
                          (e = e.parent()),
                    ...
                    (p.$onKeyDown = function (t) {
                      if (
                        ...
                        var b = 2 === y && C,
                          $ = (2 === y && !C) || (3 === y && C);
                        0 === y
                          ? (e.setHours(n + g * parseInt(h.hourStep, 10)),
                            (r = v(e, T).length),
                            (m = [0, r]))
                          : 1 === y
                          ? (e.setMinutes(i + g * parseInt(h.minuteStep, 10)),
                            (o = v(e, k).length),
                            (m = [r + c, o]))
                          : b
                          ? (e.setSeconds(a + g * parseInt(h.secondStep, 10)),
                            (s = v(e, E).length),
                            (m = [r + c + o + c, s]))
                          : $ &&
                            (l || p.switchMeridian(),
                  ...
                  var D = p.init;
                  p.init = function () {
                    return c && h.useNative
                      ? (e.prop("type", "time"),
                        void e.css("-webkit-appearance", "textfield"))
                      : (l &&
                          (e.prop("type", "text"),
                ...
                var c = /(ip[ao]d|iphone|android)/gi.test(
                    e.navigator.userAgent
                  ),
                  l = "createTouch" in e.document && c;
                return (
                  t.lang || (t.lang = o.getDefaultLocale()), (u.defaults = t), u
                );
              },
            ];
          })
                ...
                link: function (t, e, r, c) {
                  function l(t) {
                    if (angular.isDate(t)) {
                      var e =
                          isNaN(p.minTime) ||
                          new Date(t.getTime()).setFullYear(1970, 0, 1) >=
                            p.minTime,
                        n =
                          isNaN(p.maxTime) ||
                          new Date(t.getTime()).setFullYear(1970, 0, 1) <=
                  ...
                  function f() {
                    return !c.$dateValue || isNaN(c.$dateValue.getTime())
                      ? ""
                      : g(c.$dateValue, p.timeFormat);
                  }
                  var p = {
                    scope: t,
                  };
                  ...
                  angular.forEach(["minTime", "maxTime"], function (t) {
                    ...
                    c.$parsers.unshift(function (t) {
                      ...
                      return !r || isNaN(r.getTime())
                        ? (c.$setValidity("date", !1), n)
                        : (l(r),
                          "string" === p.timeType
                            ? ((e = v.timezoneOffsetAdjust(r, p.timezone, !0)),
                              g(e, p.modelTimeFormat || p.timeFormat))
                            : ((e = v.timezoneOffsetAdjust(
                                c.$dateValue,
                                p.timezone,
                                !0
                              )),
                      ...
                      return (
                        (e =
                          angular.isUndefined(t) || null === t
                            ...
                            ? t
                            : "string" === p.timeType
                            ? v.parse(t, null, p.modelTimeFormat)
                            : "unix" === p.timeType
                            ? new Date(1e3 * t)
                            : new Date(t)),
            ...
            var t = (this.defaults = {
              ...
              e = (this.controller = function (e, n, r) {
                ...
                (i.$options = angular.copy(t)),
                  ...
                  (i.$push = function (t) {
                    angular.isUndefined(i.$panes.$active) &&
                      e.$setActive(t.name || 0),
                      i.$panes.push(t);
                  }),
                  (i.$remove = function (t) {
                    var e,
                    ...
                    (e = angular.isString(r)
                      ...
                      e >= 0 && e < i.$panes.length
                        ? i.$setActive(i.$panes[e].name || e)
                        : i.$setActive();
                  }),
                  (i.$setActive = e.$setActive =
                    function (t) {
                      (i.$panes.$active = t),
                  ...
                  (i.$isActive = e.$isActive =
                    function (t, e) {
                      return (
                        i.$panes.$active === t.name || i.$panes.$active === e
                      );
                    });
              });
            this.$get = function () {
              ...
              return {
                ...
                link: function (t, r, i, o) {
                  function a() {
                    ...
                    e[s.$isActive(t, n) ? "addClass" : "removeClass"](
                      r,
              ...
              function (e, r, i, o, a) {
                function s(i, s, u) {
                  ...
                  (p.$matches = []),
                    ...
                    (l.activate = function (t) {
                      return (
                        f.multiple
                          ? (l.$isActive(t)
                              ? p.$activeIndex.splice(
                                  p.$activeIndex.indexOf(t),
                                  1
                                )
                              : p.$activeIndex.push(t),
                            f.sort &&
                              p.$activeIndex.sort(function (t, e) {
                                return t - e;
                              }))
                          : (p.$activeIndex = t),
                        p.$activeIndex
                      ...
                      if (
                        ...
                        p.$apply(function () {
                          l.activate(t),
                            f.multiple
                              ? s.$setViewValue(
                                  p.$activeIndex.map(function (t) {
                                    return angular.isUndefined(p.$matches[t])
                                      ? null
                                      : p.$matches[t].value;
                                  })
                                )
                              : (f.toggle
                                  ? s.$setViewValue(e === s.$modelValue ? n : e)
                                  : s.$setViewValue(e),
                                l.hide());
                        }),
                          p.$emit(f.prefixEvent + ".select", e, t, l),
                          angular.isDefined(f.onSelect) &&
                            angular.isFunction(f.onSelect) &&
                            f.onSelect(e, t, l);
                      }
                    }),
                    (l.$updateActiveIndex = function () {
                      f.multiple
                        ? angular.isArray(s.$modelValue)
                          ? (p.$activeIndex = s.$modelValue.map(function (t) {
                              return l.$getIndex(t);
                            }))
                          : (p.$activeIndex = [])
                        : angular.isDefined(s.$modelValue) && p.$matches.length
                        ? (p.$activeIndex = l.$getIndex(s.$modelValue))
                        : (p.$activeIndex = -1);
                    }),
                    (l.$isVisible = function () {
                      return f.minLength && s
                        ? p.$matches.length &&
                            s.$viewValue.length >= f.minLength
                        : p.$matches.length;
                    }),
                    (l.$isActive = function (t) {
                      return f.multiple
                        ? -1 !== p.$activeIndex.indexOf(t)
                        : p.$activeIndex === t;
                    }),
                    (l.$getIndex = function (t) {
                      ...
                      for (
                        e = p.$matches.length;
                        e-- && !angular.equals(p.$matches[e].value, t);
                    ...
                    (l.$onMouseDown = function (t) {
                      if ((t.preventDefault(), t.stopPropagation(), c)) {
                        var e,
                          n = angular.element(t.target);
                        if ("A" !== t.target.nodeName)
                          for (var r = n.parent(); !e && r.length > 0; )
                            "A" === r[0].nodeName && (e = r), (r = r.parent());
                        e
                    ...
                    (l.$onKeyDown = function (t) {
                      return /(9|13|38|40)/.test(t.keyCode)
                        ? (9 !== t.keyCode &&
                            (t.preventDefault(), t.stopPropagation()),
                          f.multiple && 9 === t.keyCode
                            ? l.hide()
                            : f.multiple ||
                              (13 !== t.keyCode && 9 !== t.keyCode)
                            ? void (
                                f.multiple ||
                                (38 === t.keyCode && p.$activeIndex > 0
                                  ? p.$activeIndex--
                                  : 38 === t.keyCode && p.$activeIndex < 0
                                  ? (p.$activeIndex = p.$matches.length - 1)
                                  : 40 === t.keyCode &&
                                    p.$activeIndex < p.$matches.length - 1
                                  ? p.$activeIndex++
                                  : angular.isUndefined(p.$activeIndex) &&
                                    (p.$activeIndex = 0),
                                p.$digest())
                              )
                            : l.select(p.$activeIndex))
                        : void 0;
                    }),
                    (l.$isIE = function () {
                  ...
                  return (
                    (l.hide = function () {
                      !f.multiple &&
                        angular.isUndefined(s.$modelValue) &&
                        (p.$activeIndex = -1),
                        l.$element.off(
                          c ? "touchstart" : "mousedown",
                          l.$onMouseDown
                ...
                var u = /(ip[ao]d|iphone|android)/gi.test(
                    e.navigator.userAgent
                  ),
            ...
            function (t, e, n, r, i) {
              ...
              return {
                ...
                link: function (t, e, n, a) {
                  ...
                  if (
                    (angular.isDefined(c) &&
                      (u.test(c) ? (s.multiple = !1) : (s.multiple = c)),
                  ...
                  var f = i(n.bsOptions),
                    p = r(e, a, s);
                  p.$isIE() &&
                    e[0].addEventListener("blur", p.$selectScrollFix);
                  ...
                  t.$watch(
                    ...
                    (a.$render = function () {
                      var t, n;
                      s.multiple && angular.isArray(a.$modelValue)
                        ? ((t = a.$modelValue
                            .map(function (t) {
                              return (
                                (n = p.$getIndex(t)),
                          ...
                          (t =
                            t.length > (s.maxLength || o.maxLength)
                              ? t.length +
                                " " +
                                (s.maxLengthHtml || o.maxLengthHtml)
                              : t.join(", ")))
                        : ((n = p.$getIndex(a.$modelValue)),
                          (t = -1 !== n ? p.$scope.$matches[n].label : !1)),
                        e.html(
                          (t || s.placeholder) + (s.caretHtml || o.caretHtml)
                        );
                    }),
                    s.multiple &&
            ...
            this.$get = [
              ...
              function (r, i, o, a, s, u) {
                function c(t, e) {
                  return (
                    t[0].nodeName &&
                    t[0].nodeName.toLowerCase() === e.toLowerCase()
                  );
                }
                function l(i) {
                  ...
                  return (
                    ...
                    (k.checkPosition = function () {
                      if (C.length) {
                        if (
                          ((_ = (h ? r.pageYOffset : m.prop("scrollTop")) || 0),
                        ...
                        for (var t = C.length; t--; )
                          if (
                            !angular.isUndefined(C[t].offsetTop) &&
                            null !== C[t].offsetTop &&
                            b !== C[t].target &&
                            !(
                              _ < C[t].offsetTop ||
                              (C[t + 1] && _ > C[t + 1].offsetTop)
                            )
                          )
                    ...
                    (k.$activateElement = function (t) {
                      if (b) {
                        ...
                        e &&
                          (e.source.removeClass("active"),
                          c(e.source, "li") &&
                            c(e.source.parent().parent(), "li") &&
                            e.source.parent().parent().removeClass("active"));
                      }
                      (b = t.target),
                        t.source.addClass("active"),
                        c(t.source, "li") &&
                          c(t.source.parent().parent(), "li") &&
                          t.source.parent().parent().addClass("active");
                    }),
              ...
              return {
                ...
                link: function (t, e, n) {
                  ...
                  o.trackElement(i.target, e),
                    t.$on("$destroy", function () {
                      o && (o.untrackElement(i.target, e), o.destroy()),
                        (i = null),
                        (o = null);
                    });
                },
              ...
              return {
                ...
                link: function (t, i, o) {
                  ...
                  angular.isDefined(c) &&
                    ...
                    o.bsShow &&
                      t.$watch(o.bsShow, function (t) {
                        a &&
                          angular.isDefined(t) &&
                          (angular.isString(t) &&
                            (t = !!t.match(/true|,?(popover),?/i)),
                          t === !0 ? a.show() : a.hide());
                      }),
                    o.bsEnabled &&
                      t.$watch(o.bsEnabled, function (t) {
                        a &&
                          angular.isDefined(t) &&
                          (angular.isString(t) &&
                            (t = !!t.match(/true|1|,?(popover),?/i)),
                          t === !1 ? a.setEnabled(!1) : a.setEnabled(!0));
                      }),
                    o.viewport &&
                      t.$watch(o.viewport, function (t) {
                        a && angular.isDefined(t) && a.setViewport(t);
                      }),
                    (a = n(i, s)),
                    t.$on("$destroy", function () {
                    ...
                    t.$watch(
                      ...
                      function (t) {
                        ...
                        angular.forEach(e, function (e) {
                          ...
                          i.test(t)
                            ? n.addClass(o.activeClass)
                            : n.removeClass(o.activeClass);
                        });
                      }
                    );
                },
                ...
                function u(e) {
                  function n() {
                    C.$emit(k.prefixEvent + ".show", _),
                      angular.isDefined(k.onShow) &&
                        angular.isFunction(k.onShow) &&
                        k.onShow(_);
                  }
                  function a() {
                    C.$emit(k.prefixEvent + ".hide", _),
                      angular.isDefined(k.onHide) &&
                        angular.isFunction(k.onHide) &&
                        k.onHide(_),
                      l(".modal").length <= 0 &&
                        d.removeClass(k.prefixClass + "-open"),
                      k.animation &&
                        d.removeClass(k.prefixClass + "-with-" + k.animation);
                  }
                  function u() {
                    k.backdrop &&
                      (D.on("click", w), A.on("click", w), A.on("wheel", S));
                  }
                  function y() {
                    k.backdrop &&
                      (D.off("click", w), A.off("click", w), A.off("wheel", S));
                  }
                  function b() {
                  ...
                  function w(t) {
                    t.target === t.currentTarget &&
                      ("static" === k.backdrop ? _.focus() : _.hide());
                  }
                  function S(t) {
                    t.preventDefault();
                  }
                  ...
                  k.element || k.container || (k.container = "body"),
                    k.zIndex && ((m = parseInt(k.zIndex, 10)), (g = m - 10)),
                  ...
                  var x,
                    ...
                    P,
                    A = angular.element(
                      '<div class="' + k.prefixClass + '-backdrop"/>'
                    );
                  return (
                    A.css({
                      position: "fixed",
                    ...
                    (_.show = function () {
                      if (!_.$isShown) {
                        var t, e;
                        if (
                          (angular.isElement(k.container)
                            ? ((t = k.container),
                              (e = k.container[0].lastChild
                                ? angular.element(k.container[0].lastChild)
                                : null))
                            : k.container
                            ? ((t = l(k.container)),
                              (e =
                                t[0] && t[0].lastChild
                                  ? angular.element(t[0].lastChild)
                                  : null))
                            : ((t = null), (e = k.element)),
                          D && T(),
                          (P = _.$scope.$new()),
                          ...
                          k.backdrop &&
                            ...
                            h++),
                          !C.$emit(k.prefixEvent + ".show.before", _)
                            .defaultPrevented)
                        ) {
                          angular.isDefined(k.onBeforeShow) &&
                            angular.isFunction(k.onBeforeShow) &&
                            k.onBeforeShow(_),
                            D.css({
                              display: "block",
                            ...
                            k.size &&
                              v[k.size] &&
                              angular
                                .element(l(".modal-dialog", D[0]))
                                .addClass(v[k.size]),
                            k.animation &&
                              (k.backdrop && A.addClass(k.backdropAnimation),
                              D.addClass(k.animation)),
                            k.backdrop && o.enter(A, d, null),
                            angular.version.minor <= 2
                              ? o.enter(D, t, e, n)
                              : o.enter(D, t, e).then(n),
                          ...
                          p(function () {
                            ...
                            k.animation &&
                              d.addClass(
                                k.prefixClass + "-with-" + k.animation
                              ),
                            u(),
                            b();
                        }
                    ...
                    (_.hide = function () {
                      _.$isShown &&
                        (C.$emit(k.prefixEvent + ".hide.before", _)
                          .defaultPrevented ||
                          (angular.isDefined(k.onBeforeHide) &&
                            angular.isFunction(k.onBeforeHide) &&
                            k.onBeforeHide(_),
                          angular.version.minor <= 2
                            ? o.leave(D, a)
                            : o.leave(D).then(a),
                          k.backdrop && (h--, o.leave(A)),
                          (_.$isShown = C.$isShown = !1),
                          c(C),
                          y(),
                          $()));
            ...
            return (
              ...
              (n.offset = function (e) {
                ...
                return {
                  ...
                  top:
                    n.top +
                    (t.pageYOffset || r.documentElement.scrollTop) -
                    (r.documentElement.clientTop || 0),
                  left:
                    n.left +
                    (t.pageXOffset || r.documentElement.scrollLeft) -
                    (r.documentElement.clientLeft || 0),
                };
              }),
              (n.setOffset = function (t, e, r) {
                ...
                "static" === f && (t.style.position = "relative"),
                  ...
                  (l =
                    ...
                    (a + c).indexOf("auto") > -1),
                  l
                    ? ((i = n.position(t)), (s = i.top), (o = i.left))
              ...
              (n.height = function (t, e) {
                ...
                return (
                  e
                    ? (r +=
                        n.css(t, "marginTop", !0) +
                        n.css(t, "marginBottom", !0))
                    : (r -=
                        n.css(t, "paddingTop", !0) +
                        n.css(t, "paddingBottom", !0) +
                        n.css(t, "borderTopWidth", !0) +
                        n.css(t, "borderBottomWidth", !0)),
                  r
                );
              }),
              (n.width = function (t, e) {
                ...
                return (
                  e
                    ? (r +=
                        n.css(t, "marginLeft", !0) +
                        n.css(t, "marginRight", !0))
                    : (r -=
                        n.css(t, "paddingLeft", !0) +
                        n.css(t, "paddingRight", !0) +
                        n.css(t, "borderLeftWidth", !0) +
                        n.css(t, "borderRightWidth", !0)),
                  r
                );
              }),
              n
        ...
        angular
          ...
          .provider("$dateParser", [
            ...
            function () {
              ...
              function r(t, e) {
                for (
                  var n = t.length, r = e.toString().toLowerCase(), i = 0;
                  n > i;
                  i++
                )
                  ...
                  var u = function (u) {
                    ...
                    function g(t) {
                      for (
                        ...
                        (n = e[1]), (r = o[n]), (i = S[r]), s.push(i);
                      return s;
                    }
                    var v,
                      y,
                      b = angular.extend({}, o, u),
                      $ = {},
                      w = {
                        sss: "[0-9]{3}",
                        ss: "[0-5][0-9]",
                      ...
                      S = {
                        ...
                        MMM: function (t) {
                          return this.setMonth(
                            r(a.DATETIME_FORMATS.SHORTMONTH, t)
                          );
                        },
                        MM: function (t) {
                        ...
                        y: function (t) {
                          return 50 >= 1 * t && 2 === t.length
                            ? this.setFullYear(2e3 + 1 * t)
                            : this.setFullYear(1 * t);
                        },
                      };
                    return (
                      ($.init = function () {
                      ...
                      ($.parse = function (e, n, r, i) {
                        ...
                        for (
                          var f =
                              n && !isNaN(n.getTime())
                                ? new t().fromDate(n)
                                : new t().fromDate(new Date(1970, 0, 1, 0)),
                            p = 0;
                          p < l.length - 1;
                          p++
                        )
                      ...
                      ($.getDateForAttribute = function (t, e) {
                        ...
                        if ("today" === e) {
                          ...
                          r =
                            angular.isString(e) && e.match(/^".+"$/)
                              ? new Date(e.substr(1, e.length - 2))
                              : n(e)
                              ? new Date(parseInt(e, 10))
                              : angular.isString(e) && 0 === e.length
                              ? "minDate" === t
                                ? -(1 / 0)
                                : +(1 / 0)
                              : new Date(e);
                      ...
                      ($.getTimeForAttribute = function (t, e) {
                        ...
                        return (r =
                          "now" === e
                            ...
                            : angular.isString(e) && e.match(/^".+"$/)
                            ? new Date(e.substr(1, e.length - 2)).setFullYear(
                                1970,
                                0,
                                1
                              )
                            : n(e)
                            ? new Date(parseInt(e, 10)).setFullYear(1970, 0, 1)
                            : angular.isString(e) && 0 === e.length
                            ? "minTime" === t
                              ? -(1 / 0)
                              : +(1 / 0)
                            : $.parse(e, new Date(1970, 0, 1, 0)));
                      }),
                ...
                function o(e, o) {
                  ...
                  c.$onKeyDown = function (t) {
                    if (/(38|40)/.test(t.keyCode)) {
                      ...
                      var e = angular.element(
                        c.$element[0].querySelectorAll("li:not(.divider) a")
                      );
                      if (e.length) {
                        var n;
                    ...
                    p(),
                      i(
                        function () {
                          l.keyboard &&
                            c.$element &&
                            c.$element.on("keydown", c.$onKeyDown),
                            a.on("click", u);
                        },
                        0,
                        !1
                  ...
                  c.hide = function () {
                    c.$isShown &&
                      (l.keyboard &&
                        c.$element &&
                        c.$element.off("keydown", c.$onKeyDown),
                      a.off("click", u),
                ...
                compile: function (t, e) {
                  if (!e.bsDropdown) {
                    for (var i = t[0].nextSibling; i && 1 !== i.nodeType; )
                      i = i.nextSibling;
                    i &&
                      i.className.split(" ").indexOf("dropdown-menu") >= 0 &&
                      ((e.template = i.outerHTML),
                      (e.templateUrl = n),
                  ...
                  return function (t, n, i) {
                    ...
                    var s = r(n, o);
                    i.bsShow &&
                      t.$watch(i.bsShow, function (t) {
                        s &&
                          angular.isDefined(t) &&
                          (angular.isString(t) &&
                            (t = !!t.match(/true|,?(dropdown),?/i)),
                          t === !0 ? s.show() : s.hide());
                      }),
                      t.$on("$destroy", function () {
                        s && s.destroy(), (o = null), (s = null);
              ...
              function (e, n, r, i, o, a, s, u) {
                function c(e, n, r) {
                  ...
                  (h.$select = function (t, e) {
                    ...
                    (h.$setToday = function () {
                      d.autoclose
                        ? (c.setMode(0), c.select(new Date()))
                        : c.select(new Date(), !0);
                    }),
                    (h.$clear = function () {
                      d.autoclose
                        ? (c.setMode(0), c.select(null))
                        : c.select(null, !0);
                    }),
                    (c.update = function (t) {
                      angular.isDate(t) &&
                        !isNaN(t.getTime()) &&
                        ((c.$date = t), v.update.call(v, t)),
                        c.$build(!0);
                    }),
                    ...
                    (c.select = function (t, e) {
                      angular.isDate(t)
                        ? (angular.isDate(n.$dateValue) &&
                            !isNaN(n.$dateValue.getTime())) ||
                          (n.$dateValue = new Date(t))
                        : (n.$dateValue = null),
                        !h.$mode || e
                          ? (n.$setViewValue(angular.copy(t)),
                            n.$render(),
                            d.autoclose &&
                              !e &&
                              u(function () {
                ...
                var l = /(ip[ao]d|iphone|android)/gi.test(
                    e.navigator.userAgent
                  ),
                  f = "createTouch" in e.document && l;
                return (
                  t.lang || (t.lang = o.getDefaultLocale()), (c.defaults = t), c
                );
              },
            ];
          })
              ...
              return {
                ...
                link: function (t, e, n, s) {
                  ...
                  function c(t) {
                    if (angular.isDate(t)) {
                      var e =
                          isNaN(d.$options.minDate) ||
                          t.getTime() >= d.$options.minDate,
                        n =
                          isNaN(d.$options.maxDate) ||
                          t.getTime() <= d.$options.maxDate,
                        r = e && n;
                  ...
                  n.bsShow &&
                    t.$watch(n.bsShow, function (t) {
                      d &&
                        angular.isDefined(t) &&
                        (angular.isString(t) &&
                          (t = !!t.match(/true|,?(datepicker),?/i)),
                        t === !0 ? d.show() : d.hide());
                    }),
                    angular.forEach(["minDate", "maxDate"], function (t) {
                      angular.isDefined(n[t]) &&
                        n.$observe(t, function (e) {
                          (d.$options[t] = g.getDateForAttribute(t, e)),
                            isNaN(d.$options[t]) || d.$build(!1),
                            c(s.$dateValue);
                        });
                    }),
                    angular.isDefined(n.dateFormat) &&
                      n.$observe("dateFormat", function (t) {
                    ...
                    angular.isDefined(n.disabledDates) &&
                      t.$watch(n.disabledDates, function (t, e) {
                    ...
                    s.$parsers.unshift(function (t) {
                      ...
                      return !n || isNaN(n.getTime())
                        ...
                        : (c(n),
                          "string" === f.dateType
                            ? ((e = g.timezoneOffsetAdjust(n, f.timezone, !0)),
                              m(e, f.modelDateFormat || f.dateFormat))
                            : ((e = g.timezoneOffsetAdjust(
                                s.$dateValue,
                                f.timezone,
                                !0
                              )),
                      ...
                      return (
                        (e =
                          angular.isUndefined(t) || null === t
                            ...
                            ? t
                            : "string" === f.dateType
                            ? g.parse(t, null, f.modelDateFormat)
                            : "unix" === f.dateType
                            ? new Date(1e3 * t)
                            : new Date(t)),
            ...
            this.$get = [
              ...
              function (n, r, i) {
                return function (o) {
                  var a = o.$scope,
                    ...
                    d = i.trustAsHtml(
                      '<th class="dow text-center">' +
                        p.join('</th><th class="dow text-center">') +
                        "</th>"
                    ),
                    h =
                      o.$date ||
                      (s.startDate
                        ? l.getDateForAttribute("startDate", s.startDate)
                        : new Date()),
                    m = {
                      year: h.getFullYear(),
                      month: h.getMonth(),
                    ...
                    g = [
                      {
                        ...
                        update: function (t, e) {
                          ...
                          t.getMonth() !== m.month
                            ? (angular.extend(m, {
                              ...
                              o.$build())
                            : (t.getDate() === m.date && 1 !== t.getDate()) ||
                              ((m.date = o.$date.getDate()),
                              o.$updateSelected());
                        },
                        build: function () {
                          var n = new Date(m.year, m.month, 1),
                            ...
                            i = new Date(
                              +n - 864e5 * e(n.getDay() - s.startWeek, 7)
                            ),
                        ...
                        isSelected: function (t) {
                          return (
                            o.$date &&
                            t.getFullYear() === o.$date.getFullYear() &&
                            t.getMonth() === o.$date.getMonth() &&
                            t.getDate() === o.$date.getDate()
                          );
                        },
                        isDisabled: function (t) {
                          ...
                          if (s.disabledDateRanges)
                            for (
                              var n = 0;
                              n < s.disabledDateRanges.length;
                              n++
                            )
                              if (
                                e >= s.disabledDateRanges[n].start &&
                                e <= s.disabledDateRanges[n].end
                              )
                                return !0;
                          return !1;
                        },
                        onKeyDown: function (t) {
                          if (o.$date) {
                            ...
                            37 === t.keyCode
                              ...
                              : 39 === t.keyCode
                              ? (e = new Date(n + 864e5))
                              : 40 === t.keyCode && (e = new Date(n + 6048e5)),
                      ...
                      },
                      {
                        ...
                        update: function (t) {
                          this.built && t.getFullYear() === m.year
                            ? t.getMonth() !== m.month &&
                              (angular.extend(m, {
                                month: o.$date.getMonth(),
                                date: o.$date.getDate(),
                      ...
                      },
                      {
                        ...
                        isSelected: function (t) {
                          return (
                            o.$date && t.getFullYear() === o.$date.getFullYear()
                          );
                        },
                        isDisabled: function (t) {
                  ...
                  return {
                    views: s.minView
                      ? Array.prototype.slice.call(g, s.minView)
                      : g,
                    viewDate: m,
                  };
                };
              ...
              e = (this.controller = function (e, n, r) {
                function i(t) {
                  for (var e = u.$targets.$active, n = 0; n < e.length; n++)
                    t < e[n] && (e[n] = e[n] - 1),
                      e[n] === u.$targets.length &&
                        (e[n] = u.$targets.length - 1);
                }
                function o(t) {
                ...
                function s(t) {
                  u.$options.allowMultiple || u.$targets.$active.splice(0, 1),
                    -1 === u.$targets.$active.indexOf(t) &&
                      u.$targets.$active.push(t);
                }
                var u = this;
                ...
                angular.forEach(
                  ...
                  (u.$setActive = e.$setActive =
                    function (t) {
                      angular.isArray(t)
                        ? (u.$targets.$active = t)
                        : !u.$options.disallowToggle && o(t)
                        ? a(t)
                        : s(t),
                        u.$viewChangeListeners.forEach(function (t) {
                          t();
                  ...
                  (u.$activeIndexes = function () {
                    return u.$options.allowMultiple
                      ? u.$targets.$active
                      : 1 === u.$targets.$active.length
                      ? u.$targets.$active[0]
                      : -1;
                  });
              });
                  ...
                  i &&
                    ...
                    i.$formatters.push(function (t) {
                      if (angular.isArray(t)) o.$setActive(t);
                        ...
                        angular.isArray(e)
                          ? -1 === e.indexOf(1 * t) && o.$setActive(1 * t)
                          : e !== 1 * t && o.$setActive(1 * t);
                      }
                      return t;
                    }));
                },
                  ...
                  return (
                    ...
                    (f.$parseOffsets = function () {
                      var t = i[0].style.position,
                        e = i[0].style.top;
                      p.inlineStyles &&
                        (i.css("position", p.offsetParent ? "" : "relative"),
                        i.css("top", "")),
                        p.offsetTop &&
                          ("auto" === p.offsetTop && (p.offsetTop = "+0"),
                          p.offsetTop.match(/^[-+]\d+$/)
                            ? ((g = 1 * -p.offsetTop),
                              (y = p.offsetParent
                                ? r.offset(S[0]).top + 1 * p.offsetTop
                                : r.offset(i[0]).top -
                                  r.css(i[0], "marginTop", !0) +
                                  1 * p.offsetTop))
                            : (y = 1 * p.offsetTop)),
                        p.offsetBottom &&
                          (b =
                            p.offsetParent && p.offsetBottom.match(/^[-+]\d+$/)
                              ? l() -
                                (r.offset(S[0]).top + r.height(S[0])) +
                                1 * p.offsetBottom +
                                1
                              : 1 * p.offsetBottom),
                        p.inlineStyles &&
                          (i.css("position", t), i.css("top", e));
                    }),
                    f.init(),
                    f
                  );
      ...
      angular.module("mgcrea.ngStrap.alert").run([
        ...
        function (t) {
          t.put(
            ...
            '<div class="alert" ng-class="[type ? \'alert-\' + type : null]"><button type="button" class="close" ng-if="dismissable" ng-click="$hide()">&times;</button> <span ng-if="title"><strong ng-bind="title"></strong>&nbsp;<span ng-bind-html="content"></span> </span><span ng-if="!title" ng-bind-html="content"></span></div>'
          );
        },
      ]),
        ...
        angular.module("mgcrea.ngStrap.tab").run([
          ...
          function (t) {
            t.put(
              "tab/tab.tpl.html",
              '<ul class="nav" ng-class="$navClass" role="tablist"><li role="presentation" ng-repeat="$pane in $panes track by $index" ng-class="[ $isActive($pane, $index) ? $activeClass : \'\', $pane.disabled ? \'disabled\' : \'\' ]"><a role="tab" data-toggle="tab" ng-click="!$pane.disabled && $setActive($pane.name || $index)" data-index="{{ $index }}" ng-bind-html="$pane.title" aria-controls="$pane.title" href=""></a></li></ul><div ng-transclude class="tab-content"></div>'
            );
          },
        ]),
    ...
    (function (t, e) {
      var n = e.isDefined,
        ...
        u = e.extend,
        c = e.toJson;
      e.module("LocalStorageModule", []).provider(
        "localStorageService",
        function () {
          (this.prefix = "ls"),
            ...
            (this.$get = [
              ...
              function (t, e, l, f, p) {
                ...
                var $ = function (t) {
                  ...
                  T = function () {
                    try {
                      ...
                      return (
                        n && ((h = e[b]), h.setItem(r, ""), h.removeItem(r)), n
                      );
                    } catch (i) {
                      return (
                        m.defaultToCookie && (b = "cookie"),
                        t.$broadcast(
                  ...
                  C = function () {
                    ...
                    try {
                      var n = 0;
                      arguments.length >= 1 &&
                        ("localStorage" === arguments[arguments.length - 1] ||
                          "sessionStorage" ===
                            arguments[arguments.length - 1]) &&
                        ((n = 1), L(arguments[arguments.length - 1]));
                      var r, i;
                      for (r = 0; r < arguments.length - n; r++)
                        if (
                          ((i = arguments[r]),
                          (!_ && m.defaultToCookie) ||
                            "cookie" === m.storageType)
                        )
                          _ ||
                            t.$broadcast(
                              "LocalStorageModule.notification.warning",
                  ...
                  P = (function () {
                    try {
                      return (
                        ...
                        ("cookie" in l &&
                          (l.cookie.length > 0 ||
                            (l.cookie = "test").indexOf.call(l.cookie, "test") >
                              -1))
                      );
                    } catch (n) {
                      return (
                      ...
                      if (
                        (null === n
                          ? (p.setTime(p.getTime() + -864e5),
                            ...
                            (n = ""))
                          : i(s) && 0 !== s
                          ? (p.setTime(p.getTime() + 24 * s * 60 * 60 * 1e3),
                            (f = "; expires=" + p.toGMTString()))
                          : 0 !== v.expiry &&
                            (p.setTime(
                              p.getTime() + 24 * v.expiry * 60 * 60 * 1e3
                            ),
                            (f = "; expires=" + p.toGMTString())),
                        e)
                      ) {
                  ...
                  O = function (e) {
                    ...
                    for (
                      var n = (l.cookie && l.cookie.split(";")) || [], r = 0;
                      r < n.length;
                      r++
                    ) {
                      ...
                      if (0 === i.indexOf($(e) + "=")) {
                        var o = decodeURIComponent(
                          i.substring(g.length + e.length + 1, i.length)
                        );
                        try {
                          var a = JSON.parse(o);
                ...
                _ &&
                  (e.addEventListener
                    ? (e.addEventListener("storage", d, !1),
                      t.$on("$destroy", function () {
                        e.removeEventListener("storage", d);
                      }))
                    : e.attachEvent &&
                      (e.attachEvent("onstorage", d),
                      t.$on("$destroy", function () {
    ...
    (createjs.deprecate = function (t, e) {
      ...
      return function () {
        ...
        return (
          console && (console.warn ? console.warn(n) : console.log(n)),
    ...
    (function () {
      ...
      (t.initialize = function (t) {
        ...
        (e._dispatchEvent = function (t, e) {
          var n,
            r,
            i = 2 >= e ? this._captureListeners : this._listeners;
          if (t && i && (r = i[t.type]) && (n = r.length)) {
            ...
            for (var a = 0; n > a && !t.immediatePropagationStopped; a++) {
              ...
              s.handleEvent ? s.handleEvent(t) : s(t),
                t.removed && (this.off(t.type, s, 1 == e), (t.removed = !1));
            }
          }
    ...
    (function () {
      ...
      (t.RAF_SYNCHED = "synched"),
        ...
        (t.setInterval = createjs.deprecate(
          t._setInterval,
          "Ticker.setInterval"
        )),
        ...
        (t.getInterval = createjs.deprecate(
          t._getInterval,
          "Ticker.getInterval"
        )),
      ...
      (t.init = function () {
        ...
        (t.getMeasuredFPS = function (e) {
          ...
          return !n || n.length < 2
            ? -1
            : ((e = Math.min(n.length - 1, e || 0 | t._getFPS())),
              1e3 / ((n[0] - n[e]) / e));
        }),
        ...
        (t._setupTick = function () {
          if (null == t._timerId) {
            ...
            if (e == t.RAF_SYNCHED || e == t.RAF) {
              ...
              if (n)
                return (
                  (t._timerId = n(e == t.RAF ? t._handleRAF : t._handleSynch)),
                  void (t._raf = !0)
                );
            }
            (t._raf = !1),
        ...
        (t._tick = function () {
          ...
          if (
            ((t._lastTime = n),
            t._ticks++,
            e && (t._pausedTicks++, (t._pausedTime += r)),
          ...
          for (
            t._tickTimes.unshift(t._getTime() - n);
      ...
      var n = window,
        r =
          n.performance.now ||
          n.performance.mozNow ||
          n.performance.msNow ||
          n.performance.oNow ||
          n.performance.webkitNow;
      (t._getTime = function () {
        return (
          ((r && r.call(n.performance)) || new Date().getTime()) - t._startTime
        );
      }),
        (createjs.Ticker = t);
    })(),
    ...
    (function () {
      ...
      function t(n, r) {
        this.AbstractTween_constructor(r),
          ...
          (this._injected = null),
          r &&
            ((this.pluginData = r.pluginData), r.override && t.removeTweens(n)),
      ...
      (t.IGNORE = {}),
        ...
        (t.tick = function (e, n) {
          for (var r = t._tweenHead; r; ) {
            var i = r._next;
            (n && !r.ignoreGlobalPause) ||
              r._paused ||
              r.advance(r.useTicks ? 1 : e),
              (r = i);
          }
        }),
        ...
        (t._installPlugin = function (e) {
          for (
            var n = (e.priority = e.priority || 0),
              r = (t._plugins = t._plugins || []),
              i = 0,
              o = r.length;
            o > i && !(n < r[i].priority);
            i++
        ...
        (t._register = function (e, n) {
          ...
          if (!n && e._paused) {
            ...
            var i = t._tweenTail;
            i
              ? ((t._tweenTail = i._next = e), (e._prev = i))
              : (t._tweenHead = t._tweenTail = e),
              !t._inited &&
                createjs.Ticker &&
        ...
        (r.wait = function (t, e) {
          return (
            t > 0 && this._addStep(+t, this._stepTail.props, null, e), this
          );
        }),
        (r.to = function (t, e, n) {
          (null == e || 0 > e) && (e = 0);
        ...
        (r._addPlugin = function (t) {
          ...
          if (n && !e[n]) {
            e[n] = !0;
            for (
              var r = this._plugins || (this._plugins = []),
                i = t.priority || 0,
                o = 0,
                a = r.length;
              a > o;
        ...
        (r._runActionsRange = function (t, e, n, r) {
          ...
          for (var u = this.position; o; ) {
            ...
            if (
              (c === e || (c > s && a > c) || (r && c === t)) &&
              (o.funct.apply(o.scope, o.params), u !== this.position)
            )
              return !0;
            o = i ? o.prev : o.next;
          }
        ...
        (r._appendProps = function (e, n, r) {
          ...
          for (i in e)
            if (
              ...
              s !== t.IGNORE &&
                (void 0 === s && (s = l[i]), (d[i] = void 0 === s ? null : s));
            }
          for (i in m) {
            a = e[i];
          ...
          (u = this._injected) &&
            ((this._injected = null), this._appendProps(u, n, !1));
        }),
        ...
        (r._addStep = function (t, n, r, i) {
          ...
          return (
            (this.duration += t), (this._stepTail = this._stepTail.next = o)
          );
        }),
    ...
    (function () {
      ...
      function t(t) {
        ...
        t instanceof Array || (null == t && arguments.length > 1)
          ? ((e = t), (n = arguments[1]), (t = arguments[2]))
          : t && ((e = t.tweens), (n = t.labels)),
      ...
      (e.addTween = function (t) {
        ...
        (e._runActionsRange = function (t, e, n, r) {
          for (var i = this.position, o = 0, a = this.tweens.length; a > o; o++)
            if ((this.tweens[o]._runActions(t, e, n, r), i !== this.position))
              return !0;
        }),
      ...
      (t.linear = function (t) {
        ...
        (t.getElasticInOut = function (t, e) {
          ...
          return function (r) {
            ...
            return (r *= 2) < 1
              ? -0.5 *
                  (t * Math.pow(2, 10 * (r -= 1)) * Math.sin(((r - i) * n) / e))
              : t *
                  Math.pow(2, -10 * (r -= 1)) *
                  Math.sin(((r - i) * n) / e) *
                  0.5 +
      ...
      (e.priority = 0),
          ...
          for (var i in r)
            if ("guide" === i) {
              ...
              if (
                ...
                break;
              var u =
                void 0 === n.prev.props.rotation
                  ? t.target.rotation || 0
                  : n.prev.props.rotation;
              if (
                ((o.startOffsetRot = u - o.startData.rotation),
                "fixed" == o.orient)
              )
                ...
                var c =
                    void 0 === r.rotation ? t.target.rotation || 0 : r.rotation,
                ...
                switch (((o.endAbsRot = c), o.orient)) {
                  ...
                  case "cw":
                    o.deltaRotation =
                      ((f + 360) % 360) + 360 * Math.abs((l / 360) | 0);
                    break;
                  case "ccw":
                    o.deltaRotation =
                      ((f - 360) % 360) + -360 * Math.abs((l / 360) | 0);
        ...
        (e.change = function (t, n, r, i, o) {
          ...
          if (a && n.props !== n.prev.props && a !== n.prev.props.guide)
            return ("guide" === r && !a.valid) ||
              "x" == r ||
              "y" == r ||
              ("rotation" === r && a.orient)
              ? createjs.Tween.IGNORE
              : void e._ratioToPositionData(o, a, t.target);
        }),
          ...
          if (r && l) {
            ...
            for (var o = 0; l > o; o++)
              (f.orient = "fixed"),
                ...
                n.moveTo(p.x, p.y),
                n.lineTo(
                  p.x + Math.cos(0.0174533 * p.rotation) * c,
                  p.y + Math.sin(0.0174533 * p.rotation) * c
                ),
                (n.strokeStyle = "black"),
                (n.lineWidth = 1.5 * u),
                n.stroke(),
        ...
        (e._solveGuideData = function (t, n) {
          ...
          for (o = i[0], a = i[1], f = 2; h > f; f += 4) {
            ...
            for (n.totalLength += v.estLength, p = 0; m > p; p++)
              (d = v.estLength), (v.weightings[p] = v.weightings[p] / d);
        ...
        (e._ratioToPositionData = function (t, n, r) {
          ...
          return (
            ...
            n.orient &&
              (t >= 0.99999 && 1.00001 >= t && void 0 !== n.endAbsRot
                ? (r.rotation = n.endAbsRot)
                : (r.rotation += n.startOffsetRot + t * n.deltaRotation)),
            r
          );
        }),
        ...
        (e._findPathProblems = function (t) {
          ...
          if (6 > n || (n - 2) % 4) {
            ...
            return (
              ...
              (r +=
                ...
                Math.max(4 * Math.ceil((n - 2) / 4) + 2, 6))
            );
          }
          for (var i = 0; n > i; i++)
          ...
          var s = t.orient;
          return s && "fixed" != s && "auto" != s && "cw" != s && "ccw" != s
      ...
      (t.prototype.needsClick = function (t) {
        ...
        (t.prototype.onTouchEnd = function (t) {
          ...
          return r &&
            ...
            u && u.fastClickLastScrollTop !== u.scrollTop)
            ? !0
        ...
        t.config([
          ...
          function (t) {
            ...
            return (
              ...
              null != e
                ? (t.defaults.headers.common["X-CSRF-Token"] = e.content)
                : void 0
            );
          },
        ]),
    ...
    function () {
      ...
      (n = angular.module("lmgtfy.student.searchIllustrations", [])),
        ...
        (t = (function () {
          ...
          return (
            (t.prototype.stepInstructions = function () {
              return [];
            }),
            (t.prototype.scenes = {
              desktop: [],
            ...
            (t.prototype.sceneForStep = function (t) {
              var n;
              return (
                (n = this.scenes[e()]), t >= n.length ? n[n.length - 1] : n[t]
              );
            }),
            t
          );
        })()),
        n.service("searchIllustrations", [
          "$injector",
          function (e) {
            return {
              find: function (n, r) {
    ...
    function () {
      angular.module("lmgtfy.student", [
        "lmgtfy",
        "lmgtfy.fixedCenterBlock",
        "lmgtfy.imagePreloader",
        "lmgtfy.student.mainController",
        "lmgtfy.student.searchIllustrator",
        "lmgtfy.student.searchInstructions",
      ]);
    }.call(this),
    (function (t, e) {
      "object" == typeof exports && "undefined" != typeof module
      ...
      function O(t, e) {
        ...
        for (a in e) if (!s[a]) return !1;
        return !0;
      }
      function R(t, e) {
        return t.length !== e.length
          ? !1
          : E(t, e).reduce(function (t, e) {
              return t && O(e[0], e[1]);
            }, !0);
      }
      function I(t) {
        if (!t) return "ui-view (defunct)";
        var e = t.creationContext
          ? t.creationContext.name || "(root)"
          : "(none)";
        return (
          "[ui-view#" +
          t.id +
      ...
      function et(t) {
        return (
          t.parent &&
            t.parent.data &&
            (t.data = t.self.data = ve(t.parent.data, t.data)),
          t.data
        );
      }
      function nt(t) {
      ...
      function ft(t) {
        ...
        if (e) {
          ...
          return (
            "SameAsCurrent" === e && n && n.abort(), He.ignored().toPromise()
          );
        }
      }
      function pt(t) {
      ...
      function gt() {
        ...
        return function (e, n) {
          return (
            (t = t || ce.$injector.get("$templateFactory")), [new ii(e, n, t)]
          );
        };
      }
      function vt(t) {
      ...
      function bt(t) {
        function e(t, e, r, i) {
          return (
            n._runtimeServices(i, t, r, e), delete vi.router, delete vi.$get, vi
          );
        }
        ...
        return (
          li.monkeyPatchPathParameterType(vi),
          (vi.router = vi),
          (vi.$get = e),
          (e.$inject = [
            "$location",
      ...
      function Et(t, e, n, r, i) {
        return function (o) {
          var a = o.which || o.button,
            s = i();
          if (
            !(a > 1 || o.ctrlKey || o.metaKey || o.shiftKey || t.attr("target"))
          ) {
            var u = n(function () {
      ...
      function xt(t, e, n, r) {
        ...
        e.$on("$destroy", function () {
          for (
            var e = t.off ? "off" : "unbind", r = 0, o = i;
            r < o.length;
            r++
          ) {
            var a = o[r];
      ...
      var It = angular,
        ...
        Wt = (function () {
          ...
          return (
            ...
            (t.prototype.parameters = function (t) {
              ...
              var e =
                (t.inherit && this.parent && this.parent.parameters()) || [];
        ...
        ue = function (t) {
          return function () {
            throw new Error(
              t + "(): No coreservices implementation for UI-Router is loaded."
            );
          };
        },
        ce = {
        ...
        Fe = (function () {
          ...
          return (
            (t.prototype.enqueue = function (t) {
              var e = this._items;
              return (
                e.push(t), this._limit && e.length > this._limit && e.shift(), t
              );
            }),
      ...
      var qe = jt("$id"),
        ...
        We = (function () {
          ...
          return (
            (e.prototype._set = function (e, n) {
              var r = this;
              n.length ||
                (n = Object.keys(t.Category)
                  .map(function (t) {
                    return parseInt(t, 10);
                  })
                  .filter(function (t) {
            ...
            (e.prototype.traceHookResult = function (e, n) {
              this.enabled(t.Category.HOOK) &&
                console.log(ze(n) + ":   <- Hook returned: " + B(200, G(e)));
            }),
            ...
            (e.prototype.traceUIViewConfigUpdated = function (e, n) {
              this.enabled(t.Category.UIVIEW) &&
                this.traceUIViewEvent(
                  "Updating",
                  e,
                  " with ViewConfig from context='" + n + "'"
                );
            }),
            (e.prototype.traceUIViewFill = function (e, n) {
              this.enabled(t.Category.UIVIEW) &&
                this.traceUIViewEvent("Fill", e, " with: " + B(200, n));
            }),
            ...
            (e.prototype.traceViewServiceEvent = function (e, n) {
              this.enabled(t.Category.VIEWCONFIG) &&
                console.log("VIEWCONFIG: " + e + " " + Ne(n));
            }),
            (e.prototype.traceViewServiceUIViewEvent = function (e, n) {
              this.enabled(t.Category.VIEWCONFIG) &&
                console.log("VIEWCONFIG: " + e + " " + I(n));
            }),
            e
          );
        })(),
          ...
          return (
            ...
            (e.prototype.invokeHook = function () {
              ...
              if (!e._deregistered) {
                ...
                try {
                  var u = i();
                  return !this.type.synchronous && se(u)
                    ? u["catch"](o).then(s, a)
                    : s(u);
                } catch (c) {
            ...
            (e.prototype.handleHookResult = function (t) {
              ...
              if (
                (Ye.traceHookResult(t, this.transition, this.options), t === !1)
              )
            ...
            (e.prototype.getNotCurrentRejection = function () {
              ...
              return t._disposed
                ...
                ? He.aborted().toPromise()
                : this.isSuperseded()
                ? He.superseded(this.options.current()).toPromise()
                : void 0;
            }),
            (e.prototype.toString = function () {
              var t = this,
                ...
                i =
                  jt("traceData.context.state.name")(e) ||
                  jt("traceData.context")(e) ||
                  "unknown",
                o = K(n.callback);
          ...
          return (
                ...
                a = function (i) {
                  ...
                  return s.map(function (r) {
                    var a = me(
                      ...
                      s =
                        e.criteriaMatchPath.scope ===
                        t.TransitionHookScope.STATE
                          ? r.state.self
                          : null,
                      u = new Xe(n, s, i, a);
                    return {
            ...
            (e.prototype.getMatchingHooks = function (e, n) {
              ...
              return o
                ...
                .filter(Oe(re, "broken event named: " + e.name))
                .reduce(Ce, [])
                .filter(function (t) {
                  return t.matches(n);
                });
      ...
      var nn = (function () {
        ...
        rn = (function () {
          ...
          return (
            (t.prototype.applyRawParams = function (t) {
              ...
              return (
                (this.paramValues = this.paramSchema.reduce(function (t, n) {
                  return C(t, e(n));
                }, {})),
                this
              );
        ...
        on = (function () {
          ...
          return (
            ...
            (t.buildToPath = function (e, n) {
              var r = t.buildPath(n);
              return n.options().inherit
                ? t.inheritParams(e, r, Object.keys(n.params()))
                : r;
            }),
            ...
            (t.equals = function (e, n, r) {
              return (
                e.length === n.length && t.matching(e, n, r).length === e.length
              );
            }),
        ...
        dn = (function () {
          ...
          return (
            ...
            (t.prototype.subContext = function (e) {
              return new t(
                on.subPath(this._path, function (t) {
                  return t.state === e;
                })
              );
            }),
            ...
            (t.prototype.getDependencies = function (t) {
              var e = this,
                ...
                o = function (t) {
                  ...
                  if (Gt(r))
                    throw new Error(
                      "Could not find Dependency Injection token: " + G(t)
                    );
                  return new sn(
                    t,
                    function () {
          ...
          return (
            (t.prototype.get = function (t) {
              ...
              if (e) {
                ...
                if (!e.resolved)
                  throw new Error(
                    "Resolvable async .get() not complete:" + G(e.token)
                  );
                return e.data;
              }
        ...
        gn = (function () {
          function e(e, n, r) {
            ...
            (this._treeChanges = on.treeChanges(
              e,
              o,
          ...
          return (
            ...
            (e.prototype.params = function (t) {
              return (
                void 0 === t && (t = "to"),
                Object.freeze(
                  this._treeChanges[t].map(Lt("paramValues")).reduce(Se, {})
                )
              );
            }),
            ...
            (e.prototype.exiting = function () {
              return T(this._treeChanges.exiting, Lt("state"))
                .map(mn)
                .reverse();
            }),
            ...
            (e.prototype.redirect = function (t) {
              ...
              "url" === this.options().source &&
                t.options().location !== !1 &&
                (r.location = "replace");
              var i = me({}, this.options(), t.options(), r);
              t = t.withOptions(i, !0);
              var o = this.router.transitionService.create(
                ...
                c = on
                  .matching(s, a, on.nonDynamicParams)
                  .filter(Ht(u(t.options().reloadState)));
              return (
                c.forEach(function (t, e) {
            ...
            (e.prototype.toString = function () {
              var t = this.from(),
                ...
                o = G(
                  n(
                    this._treeChanges.from.map(Lt("paramValues")).reduce(Se, {})
                  )
                ),
                a = this.valid() ? "" : "(X) ",
                s = ne(e) ? e.name : e,
        ...
        En = (function () {
          function t() {
            (this.enqueue = !0),
              (this.typeQueue = []),
              (this.defaultTypes = y(t.prototype, [
                "hash",
                "string",
                "query",
                "path",
      ...
      var Cn,
            ...
            (t.prototype.$inherit = function (t, e, n) {
              ...
              for (var s in i)
                if (
                  i[s] &&
                  i[s].params &&
                  ((r = Object.keys(i[s].params)), r.length)
                )
                  for (var u in r)
                    a.indexOf(r[u]) >= 0 ||
                      (a.push(r[u]), (o[r[u]] = this[r[u]]));
              return me({}, o, t);
            }),
            t
          );
        ...
        In = (function () {
          ...
          return (
            ...
            (t.prototype.resolvePath = function (t, e) {
              if (!e)
                throw new Error(
                  "No reference point given for path '" + t + "'"
                );
              for (
                var n = this.find(e),
                  r = t.split("."),
                ...
                if ("" !== r[i] || 0 !== i) {
                  ...
                  if (!a.parent)
                    throw new Error(
                      "Path '" + t + "' not valid for state '" + n.name + "'"
                    );
                  a = a.parent;
                } else a = n;
        ...
        Mn = (function () {
          ...
          return (
            ...
            (t.prototype.flush = function () {
              for (
                ...
                if (f) {
                  ...
                  var m = s[l];
                  if (((s[l] = n.length), p >= 0 && m === n.length))
                    return n.push(c), r;
            ...
            (t.prototype.attachRoute = function (t) {
              !t["abstract"] &&
                t.url &&
                this.$urlRouter.rule(this.$urlRouter.urlRuleFactory.create(t));
            }),
            t
          );
        })(),
        ...
        Hn = (function () {
          function e(t, n, r, i) {
            ...
            for (
              ...
              (a = c.exec(t)) &&
              ((s = m(a, !1)), !(s.segment.indexOf("?") >= 0));

            )
              h(s.id),
                this._params.push(
                  r.fromPath(s.id, s.type, this.config.paramMap(s.cfg, !1))
                ),
          ...
          return (
            ...
            (e.prototype.exec = function (t, e, n, r) {
              ...
              var a = Fn(this._cache, "pattern", function () {
                return new RegExp(
                  [
                    "^",
                    Pe(o._cache.path.map(Lt("_compiled"))).join(""),
                    o.config.strict === !1 ? "/?" : "",
                    "$",
                  ].join(""),
                  o.config.caseInsensitive ? "i" : void 0
            ...
            (e.prototype.parameter = function (t, e) {
              ...
              return (
                r() || (e.inherit !== !1 && i && i.parameter(t, e)) || null
              );
            }),
            (e.prototype.validates = function (t) {
              var e = function (t, e) {
                ...
                u = o
                  .map(function (t) {
                    ...
                    if (
                      ...
                      return (
                        e.raw || (r = T(r, encodeURIComponent)),
                        r.map(function (t) {
                          return e.id + "=" + t;
                        })
                      );
        ...
        Nn = (function () {
          ...
          return (
            (e.prototype.caseInsensitive = function (t) {
              return (this._isCaseInsensitive = Xt(t)
                ? t
            ...
            (e.prototype.defaultSquashPolicy = function (t) {
              ...
              return (this._defaultSquashPolicy = Xt(t)
                ? t
        ...
        zn = function (t, e) {
          return t.urlMatcher && e.urlMatcher
            ? Hn.compare(t.urlMatcher, e.urlMatcher)
            : 0;
        },
        Wn = function (t, e) {
          var n = {
      ...
      var Yn = (function () {
          ...
          return (
            ...
            (t.prototype.match = function (t) {
              ...
              for (
                var r,
                  ...
                  o = 0;
                o < n.length && (!r || 0 === this._sortFn(n[o], r.rule));
                o++
              ) {
                var a = i(n[o]);
            ...
            (t.prototype.update = function (t) {
              ...
              return t
                ? void (this.location = e.path())
                : void (e.path() !== this.location && e.url(this.location, !0));
            }),
            ...
            (t.prototype.when = function (t, e, n) {
              ...
              return (
                Xt(n && n.priority) && (r.priority = n.priority),
                this.rule(r),
                r
              );
            }),
        ...
        Kn = (function () {
          ...
          return (
            ...
            (t.prototype.registerUIView = function (t) {
              ...
              return (
                e.filter(n).length &&
                  Ye.traceViewServiceUIViewEvent(
                ...
                function () {
                  var n = e.indexOf(t);
                  return -1 === n
                    ? void Ye.traceViewServiceUIViewEvent(
                        "Tried removing non-registered uiView",
                        t
                      )
                    : (Ye.traceViewServiceUIViewEvent("<- Deregistering", t),
                      void be(e)(t));
                }
              );
            }),
        ...
        ir = (function () {
          ...
          return (
            ...
            (t.prototype.plugin = function (t, e) {
              ...
              if (!n.name)
                throw new Error(
                  "Required property `name` missing on plugin: " + n
                );
        ...
        gr = function (t, e) {
          return new dn(t.treeChanges().to)
            .subContext(e.$$state())
            .resolvePath("LAZY", t)
            .then(f);
        },
        ...
        Or = (function () {
          function e(t) {
            (this._transitionCount = 0),
              ...
              (this._pluginapi = p(Bt(this), {}, Bt(this), [
                "_definePathType",
                "_defineEvent",
                "_getPathTypes",
                "_getEvents",
        ...
        Rr = (function () {
          ...
          return (
              ...
              var r = this,
                ...
                l = function (t) {
                  if (t instanceof Ke) {
                    var e = t;
                    return (
                      (e = r.target(e.identifier(), e.params(), e.options())),
                      e.valid()
                        ? a() !== s
                          ? He.superseded().toPromise()
                          : r.transitionTo(
                              e.identifier(),
                              e.params(),
                              e.options()
                            )
                        : He.invalid(e.error()).toPromise()
                    );
                  }
                };
              return n();
            ...
            (e.prototype.target = function (t, e, n) {
              if ((void 0 === n && (n = {}), ne(n.reload) && !n.reload.name))
              ...
              if (
                ((n.reloadState =
                  n.reload === !0
                    ? r.root()
                    : r.matcher.find(n.reload, n.relative)),
                n.reload && !n.reloadState)
              )
                throw new Error(
                  "No such reload state '" +
                    (ee(n.reload) ? n.reload : n.reload.name) +
                    "'"
                );
                  ...
                  return function (n) {
                    if (n instanceof He) {
                      ...
                      if (n.type === t.RejectType.IGNORED)
                        return r && o.urlRouter.update(), ce.$q.when(a.current);
                      var s = n.detail;
                      if (
                        n.type === t.RejectType.SUPERSEDED &&
                        n.redirected &&
                        s instanceof Ke
                      ) {
                        var u = e.redirect(s);
                      ...
                      if (n.type === t.RejectType.ABORTED)
                        return r && o.urlRouter.update(), ce.$q.reject(n);
                    }
            ...
            (e.prototype.href = function (t, e, n) {
              ...
              return o && void 0 !== o.url && null !== o.url
                ? this.router.urlRouter.href(o.url, e, {
                    absolute: n.absolute,
                  })
                : null;
            }),
            (e.prototype.defaultErrorHandler = function (t) {
              return (this._defaultErrorHandler =
                t || this._defaultErrorHandler);
            }),
            (e.prototype.get = function (t, e) {
              var n = this.router.stateRegistry;
              return 0 === arguments.length
                ? n.get()
                : n.get(t, e || this.$current);
            }),
            (e.prototype.lazyLoad = function (t, e) {
              ...
              return (
                (e = e || this.router.transitionService.create(r, i)), lt(e, n)
              );
            }),
            e
          );
        ...
        Kr = (function (t) {
          ...
          return (
            ...
            (e.prototype._set = function (t, e, n, r) {
              ...
              r
                ? this._history.replaceState(t, e, i)
                : this._history.pushState(t, e, i);
            }),
            (e.prototype.dispose = function (e) {
              t.prototype.dispose.call(this, e),
          ...
          function t(t, e, n) {
            ...
            (this.path = t),
              ...
              (this.getTemplate = function (t, e) {
                return r.component
                  ? r.factory.makeComponentTemplate(
                      t,
                      e,
                      r.component,
                      r.viewDecl.bindings
          ...
          return (
            (t.prototype.load = function () {
              var t = this,
                ...
                i = {
                  template: e.when(
                    this.factory.fromConfig(this.viewDecl, r, n)
                  ),
                  controller: e.when(this.getController(n)),
                };
              return e.all(i).then(function (e) {
                return (
                  Ye.traceViewServiceEvent("Loaded", t),
        ...
        oi = (function () {
              ...
              (this.$get = [
                ...
                function (e, n, r) {
                  return (
                    (t.$templateRequest =
                      r.has &&
                      r.has("$templateRequest") &&
                      r.get("$templateRequest")),
                    (t.$http = e),
                    (t.$templateCache = n),
                    t
                  );
          ...
          return (
            ...
            (t.prototype.fromConfig = function (t, e, n) {
              ...
              return Xt(t.template)
                ? i(this.fromString(t.template, e))
                : Xt(t.templateUrl)
                ? i(this.fromUrl(t.templateUrl, e))
                : Xt(t.templateProvider)
                ? i(this.fromProvider(t.templateProvider, e, n))
                : Xt(t.component)
                ? o(t.component)
                : Xt(t.componentProvider)
                ? o(this.fromComponentProvider(t.componentProvider, e, n))
                : i(r);
            }),
        ...
        li = (function () {
          ...
          return (
            ...
            (t.prototype.when = function (e, n) {
              return (
                (re(n) || Zt(n)) && (n = t.injectableHandler(this._router, n)),
      ...
      var pi = Mt.module("ui.router.init", []),
        ...
        mi = Mt.module("ui.router.state", [
          "ui.router.router",
          "ui.router.util",
          "ui.router.angular1",
        ]),
        gi = Mt.module("ui.router", [
          "ui.router.init",
          "ui.router.state",
          "ui.router.angular1",
        ]),
          ...
          return {
            ...
            link: function (r, i, o, a) {
              ...
              (p.uiState = h.state),
                ...
                c.clickable &&
                  ((u = Et(i, n, e, c, d)), xt(i, r, u, p.uiStateOpts));
            },
          };
        },
      ];
          ...
          return {
            ...
            link: function (r, i, o, a) {
              ...
              m.forEach(function (t) {
                ...
                r.$on("$destroy", t.transitionService.onSuccess({}, s)),
                c.clickable &&
                  ((u = Et(i, n, e, c, h)), xt(i, r, u, d.uiStateOpts));
            },
          };
        },
      ];
      ...
      (_i = [
        ...
        Mt.module("ui.router.state")
          .directive("uiSref", wi)
          .directive("uiSrefActive", _i)
          .directive("uiSrefActiveEq", _i)
          .directive("uiState", Ti),
        (Dt.$inject = ["$state"]),
        (Pt.$inject = ["$state"]),
        Mt.module("ui.router.state")
          .filter("isState", Dt)
          .filter("includedByState", Pt);
      var ki;
      (ki = [
        "$view",
        "$animate",
                  ...
                  function d() {
                    if (
                      (m &&
                        ...
                        (m = null)),
                      v &&
                        (Ye.traceUIViewEvent("Destroying scope", k),
                        v.$destroy(),
                        (v = null)),
                      g)
                    ) {
      ...
      (t = angular.module("lmgtfy.gaEvent", [])),
        t.service("gaEvent", function () {
          ...
          return (
            ...
            {
              send: function (t, n) {
                return "undefined" != typeof ga && null !== ga
                  ? ga("send", e(t, n))
                  : void 0;
              },
            }
        ...
        e.directive("languageSelector", [
          ...
          function (e, r, i, o) {
            return {
              ...
              compile: function (a) {
                return (
                  e.isMobileOrTablet() ? a.append(t) : a.append(n),
                  function (t) {
                    return (
                      (t.languages = r),
                      ...
                      (t.goToLanguage = function () {
                        var e, n;
                        return (
                          (n = o.location.host.split(".")),
                          (e = [n[n.length - 2], n[n.length - 1]]),
                          "en" !== t.selectedLanguage &&
                            e.unshift(t.selectedLanguage),
                          (o.location =
                            o.location.protocol + "//" + e.join("."))
                        );
                      })
                    );
                  }
            ...
            return {
              ...
              link: function (r, i) {
                ...
                return (
                  ...
                  n.cookie.get("nav_menu")
                    ? ((a = n.get("navMenu")),
                      null != a
                        ? o(a)
                        : e.get("/my_account/nav_menu.html").then(function (t) {
    ...
    function () {
      var mod;
      (mod = angular.module("lmgtfy.stickerPopover", [
        "LocalStorageModule",
        "lmgtfy.gaEvent",
      ])),
        mod.directive("stickerPopover", [
          "$sce",
          function ($sce) {
            return {
              restrict: "C",
              ...
              link: function ($scope, $element, $attrs) {
                var variants;
                return (
                  (variants = eval($attrs.variants)),
                  ($scope.variant =
                    variants[Math.floor(Math.random() * variants.length)]),
                  angular.forEach($scope.variant, function (t, e) {
                    return "id" !== e
                      ? ($scope.variant[e] = $sce.trustAsHtml(t))
                      : void 0;
                  })
                );
              },
              controller: [
                "$scope",
                "stickerPopoverUXManager",
                "gaEvent",
                function (t, e, n) {
                  return (
                    (t.show = function () {
                      return (
                        n.send("stickerPopover:show:" + t.variant.id),
                        (t.active = !0)
                      );
                    }),
                    (t.hide = function () {
                      return (
                        n.send("stickerPopover:hide:" + t.variant.id),
                        (t.active = !1)
                      );
                    }),
        ...
        mod.service("stickerPopoverUXManager", [
          "$rootScope",
          "stickerPopoverAPI",
          "localStorageService",
          function (t, e, n) {
            return {
              ...
              managedShow: function () {
                var t;
                return (
                  (t = n.get("deferPopover")),
                  null == t || 0 >= t
                    ? e.show()
                    : null != t && t > 0
                    ? (n.set("deferPopover", t - 1), e.hide())
                    : void 0
                );
              },
        ...
        t.service("devMode", [
          ...
          function (t, e) {
            return {
              isActive: function () {
                return (
                  null != t.fetch("devMode") &&
                  /localhost|\.test$/.test(e.location.hostname)
                );
              },
              step: function () {
        ...
        t.service("deviceCheck", function () {
          return {
            ...
            isMobileOrTablet: function () {
              var t;
              return null != this.determination
                ? this.determination
                : ((t =
    ...
    function () {
      ...
      (t = angular.module("lmgtfy.gentleEncoding", [])),
        t.service("gentleEncoding", function () {
          return {
            encode: function (t) {
              return "undefined" != typeof encodeURIComponent &&
                null !== encodeURIComponent
                ? encodeURIComponent(t)
                    .replace(/%20(\D)?/g, "+$1")
                    .replace(/'/g, escape("'"))
                : escape(t).replace(/\+/g, "%2B").replace(/%20/g, "+");
            },
            decode: function (t) {
              return (
                (t = t.replace(/\+/g, " ")),
          ...
          controller: function () {
            return (
              ...
              (this.nextStepParams = function () {
                ...
                return (
                  (t = this.stepParamCache)[
                    (e = this.languageCode + "/" + this.currentContext().slug)
                  ] ||
                  (t[e] = this.isFinalContext()
                    ? ((n = this.nextStep()),
                      n
                        ? {
              ...
              (this.getPropPath = function (t, e) {
                var n, r, i, o;
                for (o = e.split("."), n = 0, i = o.length; i > n; n++)
                  (r = o[n]), (t = null != t ? t[r] : void 0);
                return t;
              }),
              (this.setPropPath = function (t, e, n) {
                var r, i, o, a, s;
                for (
                  s = e.split("."), r = s.pop(), i = 0, a = s.length;
                  a > i;
                  i++
                )
                  (o = s[i]), void 0 === t[o] && (t[o] = {}), (t = t[o]);
                return (t[r] = n);
              }),
              ...
              (this.proposalChangesTranslation = function (t) {
                var e, n;
                return (
                  (n = this.getPropPath(this.translations, t)),
    ...
    function () {
      var t;
      (t = angular.module("lmgtfy.wizardStep", [
        "lmgtfy.translationWizardSteps",
        "ui.router",
      ])),
        t.component("wizardStep", {
          ...
          controller: [
            "translationWizardSteps",
            "$state",
            "$rootScope",
            function (t, e, n) {
              return (
                (this.$onInit = (function (t) {
                  return function () {
                    return (
                      (n.translations = t.translations),
    ...
    function () {
      var t;
      (t = angular.module("lmgtfy.translationSubmissionReviewWizard", [
        "lmgtfy",
        "lmgtfy.translationService",
        "lmgtfy.wizardStep",
        "lmgtfy.translationWizard",
        "serverValue",
        "ui.router",
      ])),
        t.config([
                ...
                resolve: {
                  nativeLanguage: [
                    ...
                    function (t) {
                      return (
                        this.nativeLanguage ||
                        (this.nativeLanguage = t.loadTranslation("en"))
                      );
                    },
                  ],
                  translations: [
                    ...
                    function (t, e) {
                      return (
                        this.translations ||
                        (this.translations = t.loadTranslation(e.locale))
                      );
                    },
                  ],
                  translationProposals: [
              ...
              return (
                (this.reject = function () {
                  return (
                    (this.submitting = !0),
                    e
                      .put("/admin/translation_submissions/" + t + "/reject")
                      .then(function (t) {
    ...
    function () {
      var t;
      (t = angular.module("lmgtfy.translationSubmissionsWizard", [
        "lmgtfy",
        "lmgtfy.translationService",
        "lmgtfy.wizardStep",
        "lmgtfy.translationWizard",
                ...
                resolve: {
                  ...
                  translations: [
                    ...
                    function (t, e, n) {
                      return (
                        this.translations ||
                        (this.translations = n.isActive()
                          ? t.loadTranslation(
                              n._targetState._params.languageCode
                            )
                          : t.loadTranslation(e.params.languageCode))
                      );
                    },
                  ],
                },
                    ...
                    (i = (function (t) {
                      return function (e) {
                        ...
                        return (
                          ...
                          (n = e.data.id),
                          (r.location =
                            "/translation_submissions/" + n + ".html")
                        );
                      };
                    })(this)),
                    (t = (function (t) {
          ...
          function (t) {
            return {
              ...
              loadTranslationProposals: function (e) {
                return t
                  .get("/admin/translation_submissions/" + e + ".json")
                  .then(function (t) {
                    var e, n, r, i, o;
                    for (
                      r = {
              ...
              contexts: [
                {
                  slug: "menu",
                  translationKeys: [
                    "layouts.navbar.logged_in_as",
                    "layouts.navbar.my_account",
                    "layouts.navbar.logout",
                  ],
                },
              ],
            },
              ...
              contexts: [
                {
                  slug: "main",
                  translationKeys: [
                    "links.new.search_type",
                    "links.teacher.search_term_input.search_placeholder",
                    "links.new.get_link",
                    "links.new.preview",
                    "links.new.include_internet_explainer",
                  ],
                },
                {
                  slug: "search-types",
                  translationKeys: [
                    "search_types.web",
                    "search_types.books",
                    "search_types.finance",
                    "search_types.images",
                    "search_types.maps",
                    "search_types.news",
                    "search_types.shopping",
              ...
              contexts: [
                {
                  slug: "main",
                  translationKeys: [
                    "links.new.share_the_link_below",
                    "links.new.shorten_link",
                    "links.new.change_search",
                  ],
                },
              ],
            },
              ...
              contexts: [
                {
                  slug: "internet",
                  translationKeys: [
                    "links.show.this_for_is_the_internet",
                    "links.show.is_the_internet",
                  ],
                },
                {
                  slug: "search",
                  translationKeys: [
                    "links.show.these",
                    "links.show.let_your_search_it",
                    "links.show.theres_more",
                  ],
                },
                {
                  slug: "recommend",
                  translationKeys: [
                    "links.show.next_time_you_have_a_question",
                    "links.show.i_recommend",
                    "links.show.using",
                  ],
                },
                {
                  slug: "works",
                  translationKeys: [
                    "links.show.it_works_like",
                    "links.show.this_for_it_works_like",
                  ],
                },
              ],
            },
              ...
              contexts: [
                {
                  slug: "step",
                  translationKeys: [
                    "search_illustration.step",
                    "search_illustration.user_click_prompt",
                  ],
                },
                {
                  slug: "instructions",
                  translationKeys: [
                    "search_illustration.visit",
                    "search_illustration.type_your_question",
                    "search_illustration.click_the_button",
                    "search_illustration.thats_it",
                  ],
                },
                {
                  slug: "g-buttons",
                  translationKeys: [
                    "search_illustration.google_search",
                    "search_illustration.feeling_lucky",
                  ],
                },
                {
                  slug: "a-buttons",
              ...
              contexts: [
                {
                  slug: "main",
                  translationKeys: [
                    "layouts.footer.about",
                    "layouts.footer.privacy",
                    "layouts.footer.contact",
                    "layouts.footer.language",
                    "layouts.footer.buy_stickers",
                    "layouts.footer.live_stream",
                  ],
                },
              ],
            },
              ...
              contexts: [
                {
                  ...
                  translationKeys: [
                    "google_disclaimer",
                    "google_illustration_disclaimer",
                  ],
                },
              ],
            },
              ...
              contexts: [
                {
                  slug: "basic",
                  translationKeys: [
                    "sticker_popover.basic.title",
                    "sticker_popover.basic.pre",
                    "sticker_popover.basic.button",
                  ],
                },
                {
                  slug: "survey",
                  translationKeys: [
                    "sticker_popover.survey.title",
                    "sticker_popover.survey.post",
                    "sticker_popover.survey.buttonA",
                    "sticker_popover.survey.buttonB",
                  ],
                },
              ],
            },
              ...
              contexts: [
                {
                  ...
                  translationKeys: [
                    "static.stickers.head.title",
                    "static.stickers.head.og_description",
                  ],
                },
                {
                  slug: "jumbotron",
                  translationKeys: [
                    "static.stickers.jumbotron.primary",
                    "static.stickers.jumbotron.secondary",
                  ],
                },
                {
                  slug: "price",
                  translationKeys: [
                    "static.stickers.price.per_sticker",
                    "static.stickers.price.s_and_h",
                    "static.stickers.price.processed_by",
                  ],
                },
                {
                  slug: "order-form",
                  translationKeys: [
                    "static.order_stripe_form.title",
                    "static.order_stripe_form.quantity_other",
                    "static.order_stripe_form.button_pay_with",
                    "static.order_stripe_form.button_processing",
                    "static.order_stripe_form.worldwide",
                  ],
                },
                {
                  slug: "payment-error",
                  translationKeys: [
                    "static.stickers.payment_error.alert",
                    "static.stickers.payment_error.try_again",
                  ],
                },
                {
                  slug: "size",
                  translationKeys: [
                    "static.stickers.size.sharing",
                    "static.stickers.size.dimensions",
                    "static.stickers.size.ideas",
                  ],
                },
                {
                  slug: "durability",
                  translationKeys: [
                    "static.stickers.durability.made_to_last",
                    "static.stickers.durability.made_from",
                  ],
                },
                {
                  slug: "craftsmanship",
                  translationKeys: [
                    "static.stickers.craftsmanship.title",
                    "static.stickers.craftsmanship.pre_link",
                    "static.stickers.craftsmanship.post_link",
                  ],
                },
                {
                  slug: "sase",
                  translationKeys: [
                    "static.stickers.sase.title",
                    "static.stickers.sase.instructions",
                    "static.stickers.sase.dollars_only",
                  ],
                },
                {
                  slug: "sightings",
                  translationKeys: [
                    "static.stickers.sightings.old_sticker_sightings",
                    "static.stickers.sightings.old_upload_instructions",
                  ],
                },
              ],
            },
    ...
    function () {
      var t;
      (t = angular.module("lmgtfy.student.mainController", [
        "lmgtfy.services",
        "lmgtfy.student.lessonPlanner",
        "lmgtfy.student.searchIllustratorDriver",
        "lmgtfy.imagePreloader",
        "lmgtfy.devMode",
      ])),
        t.controller("mainController", [
          "$scope",
          "$http",
          "$timeout",
          "$q",
          ...
          function (t, e, n, r, i, o, a, s, u) {
            ...
            return (
              ...
              a.isActive()
                ? (t.currentSlide = a.step())
                : i.shouldIncludeInternetExplainer()
                ? ((t.currentSlide = 1),
                  (c = function () {
    ...
    function () {
      var t;
      (t = angular.module("lmgtfy.student.searchIllustrator", [
        "lmgtfy.student.searchIllustratorDriver",
        "lmgtfy.student.browserFrame",
        "lmgtfy.devMode",
      ])),
        t.directive("searchIllustrator", [
          "searchIllustratorDriver",
          "$window",
          "$timeout",
          "$q",
            ...
            return {
              ...
              link: function (o) {
                ...
                return (
                  ...
                  (u = function (t, e, n) {
                    return (
                      null == e && (e = 2), null == n && (n = 1), l(d(t), e, n)
                    );
                  }),
                  ($ = function (t) {
                  ...
                  (a = function () {
                    var t;
                    return null != (t = this._singletonTippy)
                      ? t.destroy()
                      : void 0;
                  }),
                  (m = function (t, e, n, r) {
                  ...
                  (h = function (t, n) {
                    var r;
                    return (
                      (r = e.document.querySelector(t)),
                      m(r, "bottom", n, "floating-vertical")
                    );
                  }),
                  p().then(function () {
                    return (
                      l(".browser-frame-content", 2, 0),
                      f().then(function () {
                        return (
                          g($(".browser-frame-top-input"), 0),
                          l(".browser-frame-top-input").then(function () {
                            return y("startingUrl").then(function () {
                              return f(0.5).then(function () {
                                return (
                                  g(d("input"), 1, "top"),
    ...
    function () {
      var t;
      (t = angular.module("lmgtfy.student.searchInstructions", [
        "lmgtfy.student.searchIllustratorDriver",
      ])),
        t.directive("searchInstructions", [
          "searchIllustratorDriver",
          function (t) {
            return {
              restrict: "A",
              ...
              link: function (e) {
                return (
                  ...
                  e.$watch(
                    ...
                    function (n, r) {
                      return n !== r
                        ? (e.instructions.push(t.instructionForStep(n)),
                          (e.currentStep = n))
                        : void 0;
                    }
                  )
    ...
    function () {
      var t, e;
      (e = angular.module("lmgtfy.student.searchIllustratorDriver", [
        "lmgtfy.student.searchIllustrations",
        "lmgtfy.gentleEncoding",
        "lmgtfy.adSense",
      ])),
        (t = (function () {
          function t(t, e) {
        ...
        e.service("searchIllustratorDriver", [
          "searchIllustrations",
          "gentleEncoding",
          "$window",
          "$document",
          ...
          function (e, n, r, i, o) {
            return {
              ...
              searchIllustration: function () {
                return (
                  this._searchIllustration ||
                  (this._searchIllustration = e.find(
                    this.service.identifier,
                    this.searchType.identifier
                  ))
                );
              },
              ...
              footerText: function () {
                return this.searchIllustration().footerText;
              },
              disclaimer: function () {
              ...
              bindUserClick: function () {
                return angular.element(this.primaryButtonEl()).on(
                  "click",
                  (function (t) {
                    return function () {
                      return null != t.popUrl
                        ? (t.openNewWindow(t.searchUrl()),
                          t.redirectTo(t.popUrl))
                        : t.redirectTo(t.searchUrl());
                    };
                  })(this)
                );
              },
              primaryButtonEl: function () {
                return r.document.querySelector(
                  ".search-illustrator-scene-primary-button"
                );
              },
              searchUrl: function () {
                return (
                  "" + this.searchType.urlBase + n.encode(this.searchTerms)
                );
              },
              ...
              goScene: function (e) {
                return (
                  (this.currentSceneStep = e),
                  (this.currentScene = new t(
                    this.instructionForStep(e),
                    this.sceneForStep(e)
                  ))
                );
              },
    ...
    function () {
      var t;
      (t = angular.module("lmgtfy.student.lessonPlanner", [
        "lmgtfy.services",
        "lmgtfy.gentleEncoding",
        "serverValue",
      ])),
        t.service("lessonPlanner", [
          "queryParams",
          "services",
          "gentleEncoding",
          "$injector",
          function (t, e, n, r) {
            ...
            return (
              (i = function (t, e) {
                var n, r, i, o;
                for (n = null, i = 0, o = e.length; o > i; i++)
                  (r = e[i]), r.identifier === t && (n = r);
                return n;
              }),
              (o = {
                ...
                searchType: function () {
                  return i(
                    this.searchTypeIdentifier(),
                    this.service().searchTypes
                  );
                },
              ...
              (a = {
                customExperience: function () {
                  return (
                    this._customExperience ||
                    (this._customExperience = r.get("customExperience"))
                  );
                },
                serviceIdentifier: function () {
    ...
    function () {
      var t;
      (t = angular.module("lmgtfy.teacher.mainController", [
        "lmgtfy.services",
        "lmgtfy.teacher.linkBuilder",
        "lmgtfy.teacher.liveWS",
        "lmgtfy.adSense",
      ])),
        t.controller("mainController", [
          "$scope",
          ...
          function (t, e, n, r, i, o, a, s, u) {
            ...
            return (
              ...
              (t.setServiceIdentifier = function (e) {
                ...
                for (
                  ...
                  (a = i[n]),
                    a.identifier === e
                      ? ((t.selectedService = a),
                        o.push((t.link.selectedSearchType = a.searchTypes[0])))
                      : o.push(void 0);
                return o;
              }),
              (c = function () {
                return o.build(
                  t.selectedService,
                  t.link.selectedSearchType,
                  t.link.searchTerms,
                  t.link.includeExplainer
                );
              }),
              ...
              (t.shortenLink = function () {
                return n
                  .post("appli.m8tec.com/short_urlsapp", {
                    short_url: {
                      url: t.link.url,
                    },
                  })
    ...
    function () {
      var t, e, n;
      (e = angular.module("lmgtfy.teacher.searchTypeSelector", [
        "lmgtfy.deviceCheck",
      ])),
        (n =
        ...
        e.directive("searchTypeSelector", [
          "deviceCheck",
          function (e) {
            return {
              restrict: "C",
              ...
              compile: function (r) {
                return (
                  e.isMobileOrTablet() ? r.append(t) : r.append(n),
                  function (t, e, n) {
    ...
    function () {
      var t;
      t = angular.module("lmgtfy.teacher", [
        "lmgtfy",
        "lmgtfy.deviceCheck",
        "lmgtfy.gentleEncoding",
        "lmgtfy.selectOnClick",
        "lmgtfy.languageSelector",
        "lmgtfy.stickerPopover",
        "lmgtfy.teacher.serviceSelector",
        "lmgtfy.teacher.searchTypeSelector",
        "lmgtfy.teacher.mainController",
      ]);
    }.call(this),
    function () {
      var t;
      (t = angular.module("lmgtfy.teacher.linkBuilder", [
        "lmgtfy.gentleEncoding",
      ])),
        t.service("linkBuilder", [
          "gentleEncoding",
          "$window",
          function (t, e) {
            var n, r;
        ...
        (t = (function () {
          ...
          return (
            ...
            (t.prototype.sendUpdate = function (t) {
              var e;
              return (null != (e = this.websocket) ? e.readyState : void 0) ===
                this.websocket.OPEN
