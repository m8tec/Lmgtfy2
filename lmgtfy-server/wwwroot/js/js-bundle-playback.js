...
! function(e) {
    ...
    window.__wm = {
        ...
        wombat: function(e, t, n, o, r, a) {
            var c = "".concat(n).concat(o, "/"),
                ...
                h = {
                    ...
                    wombat_host: u.host,
                    wombat_opts: {
                        no_rewrite_prefixes: ["/__wb/", r, "".concat(n).concat(r.substring(1)), "/web/", c, l, "http://analytics.archive.org/", "https://analytics.archive.org/", "//analytics.archive.org/"]
                    }
                };
        ...
        bt: function(e, t, n, o, i, r, s, a, p, d, m) {
                    ...
                    window.addEventListener("message", (function(e) {
                        if (e.source === G) {
                            ...
                            if (console.log("got message %o", t), "set height" == t.event) {
                                ...
                                if (!J) return;
                                if (t.value, Y) return;
                                z.style.height = o + "px", V.style.height = n + "px", W()
                            } else if ("open modal" == t.event) V.style.height = "", document.body.classList.add("wm-modal"), window.scrollTo(0, 0), Y = !0;
                            else if ("close modal" == t.event) z.style.marginBottom = "0px", document.body.classList.remove("wm-modal"), Y = !1;
            ...
            L = P("wm-expand"), O = P("wm-capinfo"), P("wm-graph-anchor")._no_rewrite = !0, (g = I.createElement("div")).className = "yt", g.style.display = "none", g.style.width = n + "px", g.style.height = t + "px", (y = I.createElement("div")).className = "mt", y.style.display = "none", y.style.width = o + "px", y.style.height = t + "px", K.appendChild(g), K.appendChild(y);
            var Z = P("wm-sparkline-canvas");
            K.onmouseenter = Q, K.onmouseleave = Q, K.onmousemove = function(t) {
                var i, s, c = K,
                    u = function(e) {
                        var t = 0;
            ...
            var ee = P("wm-sparkline-canvas");
            if (ee.getContext && ee.getContext("2d")) {
                var te = "/__wb/sparkline?output=json&url=" + encodeURIComponent(r) + (i && "&collection=" + i || "");
                Object(c.a)("GET", te, (function(n) {
                    if (200 == n.status) {
                ...
                var ne = new Image;
                ne.src = "/__wb/sparkline?url=" + encodeURIComponent(r) + "&width=" + e + "&height=" + t + "&selected_year=" + _ + "&selected_month=" + S + (i && "&collection=" + i || ""), ne.alt = "sparkline", ne.width = e, ne.height = t, ne.id = "sparklineImgId", ne.border = "0", Z.parentNode.replaceChild(ne, Z)
            }
