      ...
      (t = angular.module("lmgtfy.student.mainController", [
        ...
        t.controller("mainController", [
          ...
          function (t, e, n, r, i, o, a, s) {
            ...
            return (
              (t.services = a),
              (t.selectedService = r.service()),
              (t.delayBeforeDone = 0.5),
              i.setService(t.selectedService),
              i.setSearchType(r.searchType()),
              i.setSearchTerms(r.searchTerms()),
              i.setPopUrl(r.popUrl()),
              (t.showAds = r.shouldShowAds()),
              (t.sponsoredByLine = r.sponsoredByLine()),
              angular.forEach(a, function (t) {
                return s.preload(t.logoSrc);
              }),
              o.isActive()
                ? (t.currentSlide = o.step())
                : r.shouldIncludeInternetExplainer()
                ? ((t.currentSlide = 1),
                  (u = function () {
          ...
          function (t, e, n, r, i, o, a, s, u) {
            ...
            return (
              ...
              (t.shortenLink = function () {
                ...
                var baseDomain = currentDomain.replace(
                  /^(?:[\w-]+\.)+([\w-]+\.[\w]+)$/,
                  "$1"
                );
      ...
      (e = angular.module("lmgtfy.teacher.liveWS", [])),
        (t = (function () {
          function t(t) {
            ...
            var r = e + "://live-ws." + baseDomain + "/lmgtfy_ws";
