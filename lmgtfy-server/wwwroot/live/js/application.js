  ...
  function gentlyEncode(e) {
    return encodeURIComponent
      ? encodeURIComponent(e)
          .replace(/%20(\D)?/g, "+$1")
          .replace(/'/g, escape("'"))
      : escape(e).replace(/\+/g, "%2B").replace(/%20/g, "+");
  }
  (jQuery.cookie = function (e, n, t) {
      ...
      return (
        $.getJSON(e, function (e) {
          var o = e.slots[rand(e.slots.length)],
            ...
            r = t.find("a");
          r.attr("href", o.url),
            r.find("img").attr("src", o.image),
            r.find("p").html(o.message),
            pageTracker &&
              (pageTracker._trackPageview("/sponsor/" + i),
              r.unbind("click"),
              r.click(function () {
      ...
      function t() {
        if (s > a.length - 1) i(0), e();
          ...
          u.find("a").attr("href", r).attr("target", "_blank").text(n),
            ...
            i(s + 1),
            o(),
            setTimeout(t, rand(3e3));
        }
      }

      function o() {
        c.children().length > 100 &&
          (o = function () {
    ...
    (function () {
      function e(e) {
        "WebSocket" in window
          ? n(e)
          : d("Your browser doesn't support web sockets.");
      }
      ...
      function n(e) {
        ...
        var wsUrl = proto + "://live-ws." + baseDomain + "/live_ws";
      ...
      function r(e) {
        e.removeClass("active").addClass("done"),
          (anchor = e.find("a")),
          anchor.attr("href", a(anchor.find(".text").text()));
      }
